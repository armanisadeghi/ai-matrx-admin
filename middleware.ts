...
export const config = {
    matcher: [
         ...
         */
        '/((?!api|_next/static|_next/image|public|login|auth|matrx|flash-cards|ava|dash|app_redirect|app_callback|sign-up|forgot-password|error|reset-password|contact|about|privacy-policy|favicon.ico|sitemap.xml|robots.txt).*)',
    ],
}
