...
export const FilePreview: React.FC = () => {
    ...
    const renderPreview = () => {
        switch (fileDetails.category) {
            case 'TEXT':
                return <TextPreview file={fileDetails} />;
            case 'IMAGE':
                return <ImagePreview file={fileDetails} />;
            case 'AUDIO':
                return <AudioPreview file={fileDetails} />;
            case 'VIDEO':
                return <VideoPreview file={fileDetails} />;
            case 'CODE':
                return <CodePreview file={fileDetails} />;
            case 'PDF':
                return <PDFPreview file={fileDetails} />;
            default:
                return <DefaultPreview file={fileDetails} />;
        }
    };
