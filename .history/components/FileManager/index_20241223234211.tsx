...
import {FileExplorerGrid} from "@/components/FileManager/FileExplorerGrid";

export const FileManager: React.FC<FileManagerProps> = ({
    defaultBucket,
    showDebugger = true,
}) => {
    const { isInitialized, isLoading, setCurrentBucket, refreshBucketStructure } = useFileSystem();
