...
const TestEntityTable: React.FC = () => {
    ...
    const data = useSelector(entitySelectors.selectData);
    const loading = useSelector(entitySelectors.selectLoading);
    const error = useSelector(entitySelectors.selectError);
    const totalCount = useSelector(entitySelectors.selectTotalCount);
    const initialized = useSelector(entitySelectors.selectInitialized);
