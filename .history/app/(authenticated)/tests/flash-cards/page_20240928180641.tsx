...
const FlashcardComponent: React.FC = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground p-4">
        ...
        <div
          className={`relative w-full max-w-md h-80 cursor-pointer rounded-md bg-indigo-700 
            transition-all ease-in-out duration-500 transform-style-3d
            ${isFlipped ? "transform rotate-y-180" : ""}`}
          onClick={handleFlip}
        >
          <div className="absolute inset-0 w-full h-full backface-hidden">
            <Card className="w-full h-full flex items-center justify-center p-6 overflow-auto">
              <CardContent>
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden transform rotate-y-180">
            <Card className="w-full h-full flex items-start justify-start p-6 overflow-auto">
              <CardContent>
