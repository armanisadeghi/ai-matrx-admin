...
export const Logo: React.FC<LogoProps> = ({
    ...
    const renderIcon = () => (
        <Infinity size={iconSize} />
    );

    const renderText = () => (
        <span className={`font-bold ${textSize}`}>AI Matrix</span>
    );
...
export const LogoHorizontal: React.FC<Omit<LogoProps, 'variant'>> = (props) => (
    <Logo {...props} variant="horizontal" />
);

export const LogoVertical: React.FC<Omit<LogoProps, 'variant'>> = (props) => (
    <Logo {...props} variant="vertical" />
);
