 ...
 * Opens via the RequestRecoveryButton or programmatically via
 * `useRequestRecovery().open()`.
 *
...
export function RecoveryWindow() {
  ...
  const handleRetry = () => {
    ...
    toast.info("Navigated to original page. Your input is preserved below.", {
      description: "Paste from the recovery tray if the composer doesn't auto-fill.",
    });
  };
