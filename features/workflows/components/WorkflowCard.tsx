...
export function WorkflowCard({ workflow }: WorkflowCardProps) {
  ...
  return (
    <Card className="group hover:shadow-lg transition-all duration-200 border border-gray-200 dark:border-gray-800 hover:border-primary/20 dark:hover:border-primary/20">
