...
import {
  ...
  NodeDefinitionType,
} from "@/features/workflows/react-flow/node-editor";
...
interface QuickAccessPanelProps {
  ...
  onFinalizeNode: (
    configuredNodeData: Omit<DbFunctionNode, "user_id"> | DbFunctionNode,
    position: XYPosition,
  ) => void;
}
...
const QuickAccessPanel: React.FC<QuickAccessPanelProps> = ({
  ...
  const [activeCategoryOverlay, setActiveCategoryOverlay] = useState<
    string | null
  >(null);
  ...
  const handleRecipeConfirm = async (
    configuredNodeData: Omit<DbFunctionNode, "user_id">,
  ) => {
