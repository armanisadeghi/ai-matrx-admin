            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wide">Core Workflow</h3>
                    </div>
                    <div className="space-y-2">
                        <button
                            onClick={() => handleAddFunction("2ac5576b-d1ab-45b1-ab48-4e196629fdd8")} // Function ID: 2ac5576b-d1ab-45b1-ab48-4e196629fdd8
                        ...
                        <button
                            onClick={() => handleAddFunction("8ff3af1c-3975-4a2d-89d1-0f799c784302")} //  Function ID: 8ff3af1c-3975-4a2d-89d1-0f799c784302
                        ...
                        >
                            ...
                            <div className="text-left">
                                <div className="text-sm font-medium text-blue-900 dark:text-blue-100">Markdown Super Processor</div>
                                <div className="text-xs text-blue-600 dark:text-blue-400">Markdown to structured data</div>
                            </div>
                        </button>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <div className="text-sm font-medium text-blue-900 dark:text-blue-100">Broker Relay</div>
                                <div className="text-xs text-blue-600 dark:text-blue-400">Route data between brokers</div>
                            </div>
                        </button>
                    </div>
                </div>
                ...
                <div className="px-4 pb-4">
                    ...
                    <div className="space-y-2">
                        <button
                            onClick={() => handleAddFunction("cbdbbf0c-e963-4b5f-bea5-87aa743fcb74")} //  Function process_markdown_with_dynamic_extraction
                            className="w-full flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors"
                        >
                            <div className="p-1 bg-purple-100 dark:bg-purple-900/50 rounded">
                            ...
                            <div className="text-left">
                                <div className="text-sm font-medium text-purple-900 dark:text-purple-100">Dynamic Extraction</div>
                                <div className="text-xs text-purple-600 dark:text-purple-400">dynamically extrtract from data</div>
                            </div>
                        </button>

                        <button
                            onClick={() => handleAddFunction("b42d270b-0627-453c-a4bb-920eb1da6c51")} //  Function orchestrate_text_operations
                        ...
                        >
                            ...
                            <div className="text-left">
                                <div className="text-sm font-medium text-green-900 dark:text-green-100">Text Orchestrator</div>
                ...
                {!showFunctionBrowser && (
                    <div className="px-4 pb-4">
                        <button
                            onClick={() => onAddNode("genericFunction", "genericFunction")}
                ...
                <div className="px-4 pb-4">
                    <div className="flex items-center justify-between mb-3">
                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wide">Integration Nodes</h3>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                        <button
                            onClick={() => onAddNode("agent", "agent")}
                        ...
                        <button
                            onClick={() => onAddNode("calendar", "calendar")}
                            className="flex flex-col items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                        >
                        ...
                        <button
                            onClick={() => onAddNode("fileOperation", "fileOperation")}
                            className="flex flex-col items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                        >
