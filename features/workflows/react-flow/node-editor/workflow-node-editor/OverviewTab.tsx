          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleNodeUpdate({ step_name: e.target.value })
                    }
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleNodeUpdate({ function_type: value })
                    }
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="registered_function">
                        Registered Function
                      </SelectItem>
                      <SelectItem value="custom_function">
                        Custom Function
                      </SelectItem>
                    </SelectContent>
                  </Select>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleNodeUpdate({ execution_required: !!checked })
                    }
                  />
                  <Label
                    htmlFor="execution-required"
                ...
                <Badge
                  variant={
                    nodeData.status === "ready_to_execute"
                      ? "default"
                      : "secondary"
                  }
                  className="text-xs"
                  ...
                  <div className="space-y-1 mt-1">
                    {allReturnBrokers.map((broker, index) => (
                      ...
                      >
                        ...
                        <Badge
                          variant={
                            broker.type === "default" ? "secondary" : "outline"
                          }
                          className="text-xs"
                        >
                          {broker.type === "default"
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <Table>
              ...
              <TableBody>
                {asWorkflowDependencies(nodeData.additional_dependencies).map(
                  (dep, index) => (
                    <TableRow key={index} className="text-xs">
                      <TableCell className="py-2 font-mono">
                        {dep.source_broker_id}
                      </TableCell>
                      <TableCell className="py-2 font-mono">
                        {dep.target_broker_id || (
                          <span className="text-muted-foreground">None</span>
                        )}
                      </TableCell>
                    </TableRow>
