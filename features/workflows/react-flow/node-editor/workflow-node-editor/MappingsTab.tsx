...
import { asArgumentMappings } from "@/features/workflows/utils/workflow-json-fields";

const MappingsTab: React.FC<TabComponentProps> = ({
  nodeData,
  onNodeUpdate,
}) => {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => addArgumentMapping(nodeData, onNodeUpdate)}
              size="sm"
            >
        ...
        <CardContent>
          {hasArgumentMappings(nodeData) ? (
            <div className="space-y-3">
              {asArgumentMappings(nodeData.arg_mapping).map(
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            removeArgumentMapping(nodeData, onNodeUpdate, index)
                          }
                        >
            ...
            <div className="text-center py-8 text-muted-foreground">
              No argument mappings configured. Click "Add Mapping" to get
              started.
            </div>
          )}
        </CardContent>
