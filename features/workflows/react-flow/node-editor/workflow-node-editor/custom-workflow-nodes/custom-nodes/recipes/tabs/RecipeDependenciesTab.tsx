...
const RecipeDependenciesTab: React.FC<RecipeDependenciesTabProps> = ({
  nodeData,
  onNodeUpdate,
  neededBrokers,
  enrichedBrokers,
}) => {
  const [previousNeededBrokers, setPreviousNeededBrokers] = useState<
    NeededBroker[]
  >([]);
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => addWorkflowDependency(nodeData, onNodeUpdate)}
              size="sm"
            >
        ...
        <CardContent>
          {dependencies.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              No workflow dependencies configured. Click "Add Dependency" to get
              started.
            </div>
          )}
        </CardContent>
