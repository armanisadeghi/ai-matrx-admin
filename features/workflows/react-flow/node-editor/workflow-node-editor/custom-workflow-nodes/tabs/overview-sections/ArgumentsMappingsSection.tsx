 ...
 */
const ArgumentsMappingsSection: React.FC<ArgumentsMappingsSectionProps> = ({
  nodeData,
  onNodeUpdate,
  argsToHide = [],
  enrichedBrokers,
  ...
  const visibleArgumentsWithData = argumentsWithData.filter(
        ...
        <Table>
          ...
          <TableBody>
            {visibleArgumentsWithData.map((arg, index) => {
              ...
              const effectiveValue = getEffectiveArgValue(arg, argOverrides);
