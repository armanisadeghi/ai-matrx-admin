      ...
      <div className="relative rounded-3xl bg-zinc-200 dark:bg-zinc-800 transition-all overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[50px] bg-zinc-200 dark:bg-zinc-800 z-5">
          <div className="absolute bottom-2 left-4 flex items-center space-x-3">
            <button className="p-2 rounded-full text-gray-800 dark:text-gray-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <div className="absolute bottom-2 right-4 flex items-center space-x-3">
            <button className="p-2 rounded-full border border-zinc-300 dark:border-zinc-700 text-gray-800 dark:text-gray-500">
              <Mic size={16} />
            </button>
            
            <div className="flex items-center ml-1 relative">
              {/* Model selection component placeholder */}
              <div className="p-2 rounded-lg text-sm text-gray-800 dark:text-gray-500">
                Matrx AI
              </div>
              
              <button className="p-2 ml-3 rounded-full text-gray-800 dark:text-gray-500 bg-zinc-300 dark:bg-zinc-700 border border-zinc-300 dark:border-zinc-700">
                <ArrowUp size={16} />
              </button>
            </div>
          </div>
