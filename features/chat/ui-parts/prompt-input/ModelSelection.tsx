...
import { DeepSeek, Gemini, Claude, OpenAI, Grok, Meta, Qwen } from "@lobehub/icons";
        ...
        return (
            <div className={`relative ${className}`} ref={dropdownRef}>
                {isMobile ? (
                    ...
                    >
                        <span className="mr-1 text-sm font-small truncate max-w-[150px]">{selectedModelName}</span>
                    </button>
                ) : (
