...
import { ContentBlock, CategoryConfig } from "../config/contentBlocks";
import {
...
export const DynamicContextMenuSection: React.FC<
  DynamicContextMenuSectionProps
> = ({ category, onBlockSelect }) => {
  const [directBlocks, setDirectBlocks] = useState<ContentBlock[]>([]);
  const [subcategoryBlocks, setSubcategoryBlocks] = useState<
