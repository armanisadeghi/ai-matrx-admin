    ...
    <ContextMenuGroup>
      ...
      >
        ...
        <div className="flex flex-col flex-1">
          <span>Edit</span>
          <span className="text-xs text-muted-foreground">
            Modify chip content or properties
          </span>
        </div>
      </ContextMenuItem>
      ...
      <ContextMenuSub>
        <ContextMenuSubTrigger className="gap-2">
          ...
          <div className="flex flex-col flex-1">
            ...
            <span className="text-xs text-muted-foreground">
              Select a new color for the chip
            </span>
          </div>
        </ContextMenuSubTrigger>
        <ContextMenuPortal>
...
export const ChipMenuProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  ...
  const showMenu = useCallback(
    (editorId: string, chipId: string, x: number, y: number) => {
