...
export const COLOR_STYLES: Record<TailwindColor, string> = {
    ...
    neutral: "bg-neutral-300 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 hover:bg-neutral-400 dark:hover:bg-neutral-700 transition-colors duration-200",
