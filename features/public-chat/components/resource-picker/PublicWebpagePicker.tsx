...
interface PublicWebpagePickerProps {
  ...
  onSwitchTo?: (
    type: "youtube" | "image_link" | "file_link",
    url: string,
  ) => void;
  initialUrl?: string;
}
