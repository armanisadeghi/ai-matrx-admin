...
interface Entity {
  ...
  entityFields: Record<
    string,
    { fieldNameFormats: { pretty: string }; dataType: string }
  >;
    ...
    <ScrollArea className="h-[calc(100vh-8rem)]">
      <div className="space-y-6 p-6">
        <div>
          ...
          <Badge
            variant={
              entity.schemaType === "table"
                ? "default"
                : entity.schemaType === "view"
                  ? "secondary"
                  : entity.schemaType === "dynamic"
                    ? "destructive"
                    : "outline"
            }
          >
          ...
          <TabsContent value="fields">
            <Card>
              <CardContent className="space-y-4">
                {Object.entries(entity.entityFields).map(
                  ([key, field]: [string, EntityField]) => (
                    <div
                      key={key}
