...
export function SchemaDetails() {
  ...
  const handleDeleteNavigate = () => {
    if (selectedElement.entityName) {
      ...
      router.push(
        `/entity-crud/${entityName}?entityPrettyName=${encodeURIComponent(entityPrettyName)}`,
      );
  ...
  const renderContent = () => {
    ...
    switch (selectedElement.type) {
      ...
      case "field":
        return (
          <FieldDetails<typeof entityName>
      ...
      case "relationship":
        return (
          <RelationshipDetails<typeof entityName>
            entity={entity as AutomationEntity<typeof entityName>}
  ...
  const entity = selectedElement.entityName
    ? schema[selectedElement.entityName]
    : null;
  const entityPrettyName =
    entity?.entityNameFormats?.pretty ||
    selectedElement.entityName ||
    "this entity";
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Navigate to the entity management page for{" "}
                      <strong>{entityPrettyName}</strong> to view and delete
                      records. This will open the management interface where you
