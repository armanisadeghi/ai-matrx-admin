...
import { buildDescribePreview } from "@/features/images/utils/build-describe-preview";
import { DESCRIBE_TEMP_FOLDER_PATH } from "@/features/image-studio/constants/describe";
...
export interface UseImageStudioResult {
  ...
  isSaving: boolean;
  lastSaveResult: import("@/features/images/studio-types").SaveStudioResult | null;
  error: string | null;
...
export function useImageStudio(
  ...
  const [lastSaveResult, setLastSaveResult] = useState<
    import("@/features/images/studio-types").SaveStudioResult | null
  >(null);
