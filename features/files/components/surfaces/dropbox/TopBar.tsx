...
export function TopBar({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 border-b bg-background px-4 py-2 shrink-0",
        className,
      )}
    >
      <NewMenu parentFolderId={parentFolderId} />
      <label className="flex flex-1 items-center gap-2 rounded-md border bg-muted/40 px-3 py-1.5 focus-within:ring-2 focus-within:ring-ring">
        <Search
