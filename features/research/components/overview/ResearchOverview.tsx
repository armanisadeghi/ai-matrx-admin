...
export default function ResearchOverview() {
  const { topicId, progress, topic, refresh, isLoading, error } =
    useTopicContext();
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60dvh] p-4 text-center">
        ...
        <p className="text-muted-foreground text-xs max-w-sm mb-5">
          Complete the setup wizard to configure your research topic, keywords,
          and settings.
        </p>
        <Button
          asChild
  ...
  return (
    <div className="p-2 space-y-3">
      ...
      {topic.description && (
        <p className="text-[11px] text-muted-foreground px-1 line-clamp-1">
          {topic.description}
        </p>
      )}
