...
export const RESEARCH_NAV_ITEMS: ResearchNavItem[] = [
  ...
  },
  {
    ...
    label: "Keywords",
    icon: "Search",
    href: (id) => `/research/topics/${id}/keywords`,
    group: "primary",
    mobileVisible: true,
  },
  {
    ...
    label: "Sources",
    icon: "Globe",
    href: (id) => `/research/topics/${id}/sources`,
    group: "primary",
    mobileVisible: true,
  },
  {
    ...
    label: "Content",
    icon: "BookOpen",
    href: (id) => `/research/topics/${id}/content`,
    group: "primary",
    mobileVisible: true,
  },
  {
    ...
    label: "Analysis",
    icon: "Brain",
    href: (id) => `/research/topics/${id}/analysis`,
    group: "primary",
    mobileVisible: true,
  },
  {
    ...
    label: "Synthesis",
    icon: "FlaskConical",
    href: (id) => `/research/topics/${id}/synthesis`,
    group: "primary",
    mobileVisible: true,
  },
  {
    ...
    label: "Document",
    icon: "FileText",
    href: (id) => `/research/topics/${id}/document`,
    group: "primary",
    mobileVisible: false,
  },
  // ── Secondary utility tabs ───────────────────────────────────────────────
  {
    ...
    label: "Tasks",
    icon: "ListChecks",
    href: (id) => `/research/topics/${id}/tasks`,
    group: "secondary",
    mobileVisible: false,
  },
  {
    ...
    label: "Tags",
    icon: "Tags",
    href: (id) => `/research/topics/${id}/tags`,
    group: "secondary",
    mobileVisible: false,
  },
  {
    ...
    label: "Media",
    icon: "Image",
    href: (id) => `/research/topics/${id}/media`,
    group: "secondary",
    mobileVisible: false,
  },
  {
    ...
    label: "Costs",
    icon: "DollarSign",
    href: (id) => `/research/topics/${id}/costs`,
    group: "secondary",
    mobileVisible: false,
  },
  {
    ...
    label: "Agents",
    icon: "Cpu",
    href: (id) => `/research/topics/${id}/agents`,
    group: "secondary",
    mobileVisible: false,
  },
  {
    ...
    label: "Settings",
    icon: "Settings2",
    href: (id) => `/research/topics/${id}/settings`,
    group: "secondary",
    mobileVisible: false,
  },
];
