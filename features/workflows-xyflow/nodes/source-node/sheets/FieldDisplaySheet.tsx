    ...
    const handleRemoveMapping = useCallback(
        (brokerId: string) => {
            ...
            if (sourceConfig?.sourceDetails) {
                ...
                const sourceIndex = userInputSources.findIndex((s) => s.brokerId === brokerId);
                if (sourceIndex !== -1) {
                    dispatch(
                ...
                <TabsContent value="fields" className="flex-1 mt-0 overflow-y-auto pr-2">
                    {sourceFieldIds.length > 0 ? (
                        ...
                        <div className="text-center py-12 text-muted-foreground pb-8 pr-2">
                            ...
                            <Button onClick={() => setActiveTab("mappings")} variant="outline" className="flex items-center gap-2">
                                <Settings className="w-4 h-4" />
                ...
                <TabsContent value="mappings" className="flex-1 mt-0 overflow-y-auto pr-2">
                    <div className="space-y-4 pb-8 pr-2">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-sm text-muted-foreground">Create and manage field mappings for your workflow.</div>
                            {!showMappingForm && (
                            ...
                            <div className="space-y-3">
                                ...
                                {userInputSources.map((source) => {
                                    ...
                                    return (
                                        <div
                                            key={source.brokerId}
                                            className="flex items-center justify-between p-3 border rounded-lg bg-muted/30 dark:bg-muted/30"
                                        >
