...
const SourceTypeSelector: React.FC<SourceTypeSelectorProps> = ({
  ...
  const existingUserInputSource = useAppSelector((state) =>
    brokerId
      ? workflowsSelectors.userInputSourceByBrokerId(
          state,
          workflowId,
          brokerId,
        )
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Choose between user input source for collecting data from users or
            data source for referencing existing database tables.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <CardContent className="pt-0">
              <CardDescription className="text-xs">
                Create input fields that users can fill out when running the
                workflow. Ideal for collecting specific data like names, dates,
          ...
          >
            ...
            <CardContent className="pt-0">
              <CardDescription className="text-xs">
                Reference existing data tables from your database. Perfect for
                using stored customer data, product catalogs, or any structured
                data.
              </CardDescription>
            </CardContent>
          </Card>
