...
const UserDataSourceSettings: React.FC<UserDataSourceSettingsProps> = ({
    ...
    const getReferenceDisplayText = (reference: UserDataReference) => {
        const typeMap = {
            table: "Entire Table",
            table_row: "Specific Row",
            table_column: "Column",
            table_cell: "Single Cell"
        };
                ...
                <DialogHeader>
                    <div className="flex items-center gap-2">
                        ...
                        <DialogTitle className="flex items-center gap-2">
                            ...
                            {mode === "create" ? "Create Data Source" : `Edit Data Source${brokerDisplayName ? ` - ${brokerDisplayName}` : ""}`}
                        </DialogTitle>
                    </div>
                </DialogHeader>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        {formData.selectedReference ? (
                                ...
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-sm font-medium text-foreground">
                                            {getReferenceDisplayText(formData.selectedReference)}
                                        </div>
                                        {formData.selectedReference.description && (
                            ...
                            <div className="flex flex-col items-center gap-3 p-6 border-2 border-dashed border-muted-foreground/30 rounded-lg">
