...
const NodeSelectionOverlay: React.FC<NodeSelectionOverlayProps> = ({ title, nodes, onAddNode, onClose, isOpen }) => {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden">
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-sm text-blue-600 dark:text-blue-300 leading-relaxed">{node.description}</p>
                                        </div>
                                    </div>
                                </button>
                            );
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-500 dark:text-gray-400">Choose a node to add to your workflow</p>
                        <button
                            onClick={onClose}
