...
const CategoryNodeSection: React.FC<CategoryNodeSectionProps> = ({
  ...
  const { categoryRecords, nodesByCategory, handleNodeAdd, isAddingNode } =
    useCategoryNodeData(workflowId);
          ...
          {Object.values(categoryRecords).map((category) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] leading-tight text-gray-700 dark:text-gray-300">
                  {category.label}
                </span>
              </button>
            );
