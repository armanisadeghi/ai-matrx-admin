...
export const OutputsTab: React.FC<DefaultTabProps> = ({ nodeId }) => {
  ...
  const outputs =
    (useAppSelector((state) =>
      workflowNodesSelectors.nodeOutputs(state, nodeId),
    ) as Output[]) || [];
  ...
  const updateOutput = (index: number, field: keyof Output, value: any) => {
    ...
    dispatch(
      workflowNodesActions.updateOutputs({
        id: nodeId,
      ...
      <div className="flex items-start justify-between py-3">
        <div className="flex-1 pr-4">
          <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">
            Outputs allow you to define one or more variations of the node's
            output and set them to different brokers
          </p>
          <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
            <li>
              • Apply bookmarks to get different parts of the output object
            </li>
              ...
              <div className="p-3 space-y-3">
                ...
                <div className="grid grid-cols-11 gap-2 items-end">
                  ...
                  <div className="col-span-3">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateOutput(index, "data_type", value)
                      }
                    >
                  ...
                  <div className="col-span-4">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateOutput(index, "broker_id", e.target.value)
                      }
                ...
                <div className="grid grid-cols-12 gap-4 items-start">
                  <div className="col-span-3 pt-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Generate bookmarks in the "Sample Results" tab and use the
                      "Copy Object" feature to get the exact bookmark needed for
                      extraction of any part of this results object
                    </p>
                  </div>
                  <div className="col-span-8">
                    ...
                    <textarea
                      ...
                      value={
                        output.bookmark
                          ? JSON.stringify(output.bookmark, null, 2)
                          : ""
                      }
                      onChange={(e) =>
                        updateBookmarkJSON(index, e.target.value)
                      }
                ...
                <div className="grid grid-cols-12 gap-4 items-start">
                  <div className="col-span-3 pt-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Enter a Target Broker ID to have this result automatically
