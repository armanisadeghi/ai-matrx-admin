...
import type { PromptSortOption, PromptTab, FavFilter, ArchFilter } from "../../hooks/usePromptFilters";

interface DesktopFilterPanelProps {
    sortBy: PromptSortOption;
    setSortBy: (v: PromptSortOption) => void;
    activeTab: PromptTab;
    setActiveTab: (v: PromptTab) => void;
    includedCats: string[];
...
function FilterSection({ label, children, active }: { label: string; children: React.ReactNode; active?: boolean }) {
    return (
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
                ...
                style={{ maxHeight: 'var(--radix-popover-content-available-height, calc(100vh - 120px))' }}
            >
                ...
                <div className="overflow-y-auto min-h-0 flex-1 p-4 space-y-5">
                    <FilterSection label="Sort" active={sortBy !== "updated-desc"}>
                        <RadioSelect value={sortBy} onChange={setSortBy} options={SORT_OPTIONS} />
                    </FilterSection>
                    ...
                    <FilterSection label="Favorites" active={favFilter !== "all"}>
                        <RadioSelect value={favFilter} onChange={setFavFilter} options={FAV_OPTIONS} />
                    </FilterSection>

                    <FilterSection label="Archived" active={archFilter !== "active"}>
                        <RadioSelect value={archFilter} onChange={setArchFilter} options={ARCH_OPTIONS} />
                    </FilterSection>
