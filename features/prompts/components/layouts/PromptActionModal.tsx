...
export function PromptActionModal({ 
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !isAnyActionActive && onClose()}>
            <DialogContent className="sm:max-w-md bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-950 border-slate-200 dark:border-slate-700">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold text-center text-gray-900 dark:text-gray-100 mb-2">
                        {promptName || "Untitled Prompt"}
                    </DialogTitle>
                    {promptDescription && (
                        <DialogDescription className="text-center text-gray-600 dark:text-gray-400 pt-2">
                            {promptDescription}
                        </DialogDescription>
                    )}
                </DialogHeader>
                ...
                <div className="space-y-4 py-6">
                    ...
                    >
                        ...
                        <div className="relative p-8 flex flex-col items-center">
                            <div className="mb-4 p-4 bg-blue-500 dark:bg-blue-600 rounded-full group-hover:bg-blue-600 dark:group-hover:bg-blue-700 transition-colors duration-300 group-hover:scale-110 transform">
                    ...
                    >
                        ...
                        <div className="relative p-8 flex flex-col items-center">
                            <div className="mb-4 p-4 bg-purple-500 dark:bg-purple-600 rounded-full group-hover:bg-purple-600 dark:group-hover:bg-purple-700 transition-colors duration-300 group-hover:scale-110 transform">
                ...
                {(showView || showDuplicate || showShare || showDelete) && (
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-3 text-center font-medium uppercase tracking-wider">
                            Additional Actions
                        </p>
                        <div className="grid grid-cols-2 gap-2">
                            {showView && onView && (
                                <Button
                                    ...
                                    disabled={isAnyActionActive}
                                    className="flex items-center justify-start gap-2 h-auto py-3 px-4 border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 relative"
                                >
                                    {activeAction === 'view' && (
                            ...
                            {showShare && onShare && (
                                <Button
                                    ...
                                    disabled={isAnyActionActive}
                                    className="flex items-center justify-start gap-2 h-auto py-3 px-4 border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800"
                                >
                            ...
                            {showDelete && onDelete && (
                                <Button
                                    ...
                                    disabled={isAnyActionActive}
                                    className="flex items-center justify-start gap-2 h-auto py-3 px-4 border-red-300 dark:border-red-800 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950 relative"
                                >
