...
import { X, FileJson, AlertCircle, Plus, Volume2, Users, AlertTriangle, ChevronLeft, Save } from "lucide-react";
...
function NumberInput({ value, onChange, onSliderChange, min, max, step = 1, isInteger = false, disabled = false, withSlider = false }: NumberInputProps) {
        ...
        return (
            <div className="flex items-center gap-2">
                <Slider
                    ...
                    step={step}
                    value={[value]}
                    onValueChange={(val) => { onSliderChange?.(val[0]); setDraft(String(val[0])); }}
                    disabled={disabled}
                    className="flex-1"
                />
                <Input
        ...
        <div className="space-y-2.5">
            ...
            {showModelSelector && (
                <div className="flex items-center gap-2 pb-2 border-b border-border">
                    <Label className="text-xs text-muted-foreground flex-shrink-0 w-36">Model</Label>
                    <Select
                        value={modelId || ''}
                        onValueChange={(value) => {
                            onModelChange?.(value);
            ...
            <div className="border-t pt-2.5 mt-2.5">
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-2 pt-1 border-t border-border">
                        <Button variant="ghost" size="sm" onClick={handleFlipBack} className="h-7 text-xs">
                            Cancel
                        </Button>
