                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-mono text-muted-foreground">
                      {settings.temperature ??
                        normalizedControls.temperature.default ??
                        0.7}
                    </span>
                  </div>
                  <Slider
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <Slider
                      ...
                      value={[
                        settings.max_tokens ??
                          (normalizedControls.max_tokens.default as number) ??
                          1000,
                      ]}
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              Nucleus sampling: limits the generated tokens to
              ...
              <div className="space-y-4">
                ...
                {normalizedControls.stream && (
                  <div className="flex items-center justify-between">
                    <Label htmlFor="stream-mode" className="cursor-pointer">
                      Stream Response
                    </Label>
                    <Switch
                      id="stream-mode"
                      ...
                      onCheckedChange={(checked) =>
                        handleSettingChange("stream", checked)
                      }
                    />
                  </div>
                )}
                ...
                {normalizedControls.json_mode && (
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      id="json-mode"
                      checked={
                        (typeof settings.response_format === "object" &&
                          (settings.response_format as any)?.type ===
                            "json_object") ||
                      ...
                      onCheckedChange={(checked) =>
                        handleSettingChange(
                          "response_format",
                          checked ? { type: "json_object" } : undefined,
                        )
                      }
                    />
                  </div>
