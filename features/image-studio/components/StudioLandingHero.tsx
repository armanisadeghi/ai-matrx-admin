...
import { ALL_PRESETS, PRESET_CATEGORIES, RECOMMENDED_BUNDLES } from "../presets";
            ...
            <section className="relative overflow-hidden border-b border-border">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 md:px-10 py-12 md:py-16 max-w-[1400px]">
                    ...
                    <p className="text-base md:text-lg text-muted-foreground mt-4 max-w-2xl leading-relaxed">
                        ...
                        e-commerce platform, every email client — generated, compressed,
                        and renamed for you. One upload, every size you&rsquo;ll ever need.
                    </p>
