      ...
      <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    onCategoryChange("placement_type", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  onCategoryChange("is_active", checked)
                }
              />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Optional JSON data for advanced use cases
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onShortcutChange("keyboard_shortcut", e.target.value)
                  }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onShortcutChange("description", e.target.value)
                }
                placeholder="Optional description"
                rows={3}
              />
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    onShortcutChange("category_id", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  onShortcutChange("is_active", checked)
                }
              />
              <span className="text-sm">Active (visible in menus)</span>
            </label>
            ...
            <div className="flex items-center gap-3">
              ...
              <Select
                ...
                onValueChange={(value: ResultDisplay) =>
                  onShortcutChange("result_display", value)
                }
              >
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onShortcutChange("auto_run", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onShortcutChange("allow_chat", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onShortcutChange("show_variables", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onShortcutChange("apply_variables", checked)
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Input
                value={(editShortcutData.available_scopes || [])
                  .filter(
                    (s) => !["selection", "content", "context"].includes(s),
                  )
                  .join(", ")}
                onChange={(e) => {
                  ...
                  onShortcutChange("available_scopes", [
                    ...commonScopes,
                    ...customScopes,
                  ]);
                }}
              ...
              <div className="space-y-2">
                ...
                {editShortcutData.prompt_builtin_id && onOpenBuiltinEditor && (
                  <Button
                    ...
                    className="w-full"
                    onClick={() =>
                      onOpenBuiltinEditor(editShortcutData.prompt_builtin_id!)
                    }
                  >
              ...
              {editShortcutData.prompt_builtin_id &&
                (() => {
                  const selectedBuiltin = builtins.find(
                    (b) => b.id === editShortcutData.prompt_builtin_id,
                  );
                  if (selectedBuiltin) {
                    const hasVariables =
                      ...
                      return (
                        <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-md border border-orange-200 dark:border-orange-800">
                          ...
                          <p className="text-xs text-orange-700 dark:text-orange-300">
                            This prompt has no variables. You may want to add
                            variables or scope mappings may not be needed.
                          </p>
                        </div>
                      );
                    }
                      ...
                      if (file) {
                        ...
                        reader.onload = (event) => {
                          try {
                            ...
                            onToast?.({
                              title: "Success",
                              description: "Scope mappings imported",
                            });
                          } catch (err) {
                            onToast?.({
                              title: "Error",
            ...
            <CardContent className="space-y-2">
              {(editShortcutData.available_scopes || []).map((scopeKey) => {
                ...
                const availableVariables =
                  selectedBuiltin?.variableDefaults?.map((v: any) => v.name) ||
                  [];
                const currentValue =
                  (editShortcutData.scope_mappings as any)?.[scopeKey] || "";
                    ...
                    >
                      ...
                      <SelectContent>
                        {availableVariables.length > 0 ? (
                          ...
                          <SelectItem value="_none_">No variables</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                    <Input
