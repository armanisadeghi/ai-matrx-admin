...
export function ShortcutFormFields({
  ...
  const selectedBuiltin = builtins.find(
    (b) => b.id === formData.prompt_builtin_id,
  );
      ...
      <div className={gridClass}>
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange({ keyboard_shortcut: e.target.value || null })
            }
        ...
        {isFromBuiltin ? (
          ...
          <div className="space-y-3">
            <Select
              ...
              onValueChange={(value) =>
                onChange({
                  prompt_builtin_id: value === "_none_" ? null : value,
                })
              }
            >
            ...
            <div className="flex gap-2">
              {formData.prompt_builtin_id && onOpenBuiltinEditor && (
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    onOpenBuiltinEditor(formData.prompt_builtin_id!)
                  }
                  className="flex-1"
                >
      ...
      {builtinVariables.length > 0 && (
        <>
          ...
          <div className="space-y-2">
            ...
            <ScopeMappingEditor
              availableScopes={
                formData.available_scopes || DEFAULT_AVAILABLE_SCOPES
              }
          ...
          <div className="flex items-center justify-between px-3 py-2 border rounded-md bg-muted/30">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onChange({ show_variables: checked })
              }
            />
          </div>
          <div className="flex items-center justify-between px-3 py-2 border rounded-md bg-muted/30">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onChange({ apply_variables: checked })
              }
            />
          </div>
        </div>
