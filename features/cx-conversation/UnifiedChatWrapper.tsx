...
import type { ConversationSessionConfig, ConversationSessionReturn } from './hooks/useConversationSession';
...
export function UnifiedChatWrapper({
    ...
    const sessionConfig: ConversationSessionConfig = useMemo(() => ({
        ...
        modelOverride,
        chatModeConfig,
    }), [agentId, apiMode, sessionIdProp, conversationId, loadHistory,
         variableDefaults, variables, requiresVariableReplacement,
         modelOverride, chatModeConfig]);
    ...
    const effectiveShowResourcePicker = authenticated ? showResourcePicker : false;
