import { DEMO_ROUTE_FAVICON, generateSVGFavicon, svgToDataURI } from '@/utils/favicon-utils';
...
export function getPromptAppIconsMetadata(
    ...
    const fallback = variant === 'demo' ? DEMO_ROUTE_FAVICON : DEFAULT_PROMPT_APP_FAVICON;
