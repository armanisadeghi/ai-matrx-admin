...
import AppletFollowUpInput, { FollowUpTurn } from "@/features/applet/runner/response/AppletFollowUpInput";
...
export default function AppletRunComponent({
    ...
    const conversationId = isFastApiPath ? fastApiResult.conversationId : undefined;
            ...
            {showFollowUpBar && (
                <div className="flex-shrink-0 border-t border-border bg-background/95 backdrop-blur-sm px-4 py-3 pb-safe">
                    <div className="w-full max-w-4xl mx-auto">
                        <AppletFollowUpInput conversationId={conversationId} onNewTurn={handleNewTurn} />
                    </div>
                </div>
            )}
        </div>
