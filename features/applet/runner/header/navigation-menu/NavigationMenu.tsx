    ...
    return (
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className={`flex items-center rounded-full pl-2 pr-1 glass shadow-sm hover:shadow-md transition cursor-pointer focus:outline-none ${creatorButtonClass} ${triggerClassName}`}
                >
