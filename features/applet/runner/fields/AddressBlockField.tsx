      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          {getFieldError('address1') && (
            <div className="text-red-500 text-xs mt-1">{getFieldError('address1')}</div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            ...
            />
            {getFieldError('city') && (
              <div className="text-red-500 text-xs mt-1">{getFieldError('city')}</div>
            )}
          </div>
          ...
          <div>
            ...
            />
            {getFieldError('state') && (
              <div className="text-red-500 text-xs mt-1">{getFieldError('state')}</div>
            )}
          </div>
          ...
          <div>
            ...
            {getFieldError('postalCode') && (
              <div className="text-red-500 text-xs mt-1">{getFieldError('postalCode')}</div>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          {getFieldError('country') && (
            <div className="text-red-500 text-xs mt-1">{getFieldError('country')}</div>
          )}
        </div>
      </div>
