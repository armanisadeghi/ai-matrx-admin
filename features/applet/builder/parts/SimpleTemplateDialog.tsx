...
interface SimpleTemplateDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onAppCreated: (appId: string) => void;
}

const SimpleTemplateDialog: React.FC<SimpleTemplateDialogProps> = ({
  isOpen,
  onClose,
  onAppCreated,
}) => {
    ...
    dispatch(
      startNewApp({
        ...
        template: {
          type: "simple",
          appName: "Simple App",
          description: "A simple app with one applet, one container, and one field",
        },
      })
    );
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-textured">
        ...
        <div className="py-4 text-gray-700 dark:text-gray-300">
          ...
          <p className="mt-4">
            This simple template is perfect for getting started quickly and
            understanding the basics of the app structure.
          </p>
...
export default SimpleTemplateDialog; 