...
import FieldRenderer from "../FieldRenderer"; // Original import
...
import NewFieldPreview from './NewFieldPreview'; // New system import
...
const FieldPreview: React.FC<FieldPreviewProps> = ({ field, componentType }) => {
    ...
    return (
        <SectionCard title="Component Preview" color="gray" spacing="relaxed">
            ...
            {field && viewAsComponentType && viewAsComponentType !== componentType && (
