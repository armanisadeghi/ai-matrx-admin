...
export const AppletOverview: React.FC<AppletOverviewProps> = ({
  appletId,
  isNew = false,
}) => {
  ...
  const appletSlug = useAppSelector((state: RootState) =>
    selectAppletSlug(state, appletId),
  );
  const appletDescription = useAppSelector((state: RootState) =>
    selectAppletDescription(state, appletId),
  );
  const appletCreator = useAppSelector((state: RootState) =>
    selectAppletCreator(state, appletId),
  );
