      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            <label
              className={`mt-1 flex items-start gap-2 ${loading ? "cursor-not-allowed opacity-60" : "cursor-pointer"}`}
            >
              <Checkbox
                ...
                onCheckedChange={() =>
                  handleSelectChange(
                    "hideDescription",
                    newGroup.hideDescription ? "false" : "true",
                  )
                }
                className="mt-0.5 shrink-0"
              />
              <span className="block text-sm text-gray-500 dark:text-gray-400">
                Hide description (Useful if the layout you choose looks busy
                with a description or if one is not needed for your use case)
              </span>
            </label>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("authenticatedRead", value)
                }
                disabled={loading}
              >
                <SelectTrigger className="w-full border-gray-200 dark:border-gray-700 bg-textured">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("publicRead", value)
                }
                disabled={loading}
              >
                <SelectTrigger className="w-full border-gray-200 dark:border-gray-700 bg-textured">
                ...
                {newGroup.fields?.map((field, index) => (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div
                        className={`w-2 h-10 rounded-sm bg-amber-500 dark:bg-amber-600 mt-1`}
                      ></div>
                      <div>
