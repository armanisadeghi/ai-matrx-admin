 ...
 */
export const fieldDefinitionToDBFormat = async (field: FieldDefinition): Promise<Omit<FieldComponentDB, 'id' | 'created_at' | 'updated_at'>> => {
...
export const duplicateFieldComponent = async (id: string): Promise<FieldDefinition> => {
  // First get the component to duplicate
