...
**Last updated:** 2026‑04‑26 (post-completion sweep + EC2 incident note + terminal live-streaming fix + AI-context bridge fix + workspace-token git auth — see [`QA_CHECKLIST.md`](./QA_CHECKLIST.md))
