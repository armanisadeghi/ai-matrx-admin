...
function Wrap({
  ...
  switch (variant) {
    case "transparent":
      return <TapTargetButtonTransparent {...props}>{children}</TapTargetButtonTransparent>;
    case "solid":
      return <TapTargetButtonSolid {...props}>{children}</TapTargetButtonSolid>;
    case "group":
      return <TapTargetButtonForGroup {...props}>{children}</TapTargetButtonForGroup>;
    default:
...
export function PanelLeftTapButton(props: TapButtonProps) {
  return (
    <Wrap ariaLabel="Toggle sidebar" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm6-2v18" />
    </Wrap>
  );
}
...
export function PanelRightTapButton(props: TapButtonProps) {
  return (
    <Wrap ariaLabel="Toggle sidebar" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm12-2v18" />
    </Wrap>
  );
}
...
export function SquarePenTapButton(props: TapButtonProps) {
  return (
    <Wrap ariaLabel="New chat" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7M18.5 2.5l3 3L12 15l-4 1 1-4 9.5-9.5" />
    </Wrap>
  );
}
