...
import {
  ...
  FormField,
  FormState,
} from "@/types/AnimatedFormTypes";
import AnimatedForm from "@/components/matrx/AnimatedForm/FormComponent";

const AnimatedFormModal: React.FC<
  AnimatedFormModalProps & { className?: string }
> = ({
  ...
  const [internalFormState, setInternalFormState] =
    useState<FormState>(externalFormState);
