...
export const EnhancedEntityChip = (
    ...
    const getGlowStyle = (variant: ChipVariants) => {
        ...
        const color = enhancedGlowColors[variant];
        const intensity = enhancedGlowIntensity[variant];
    ...
    return (
        <div className={cn(densityClasses[density])}>
            ...
            <span
                className={cn(
                    baseStyles,
                    gradient ? enhancedGradientVariants[variant as keyof typeof enhancedGradientVariants]
                             : enhancedVariants[variant as keyof typeof enhancedVariants],
                             enhancedSizes[size],
            ...
            >
                {IconComponent && (
                    <span className="mr-1">
                        <IconComponent size={enhancedIconSizes[size]} />
                    </span>
                )}
