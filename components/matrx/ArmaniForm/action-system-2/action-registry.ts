...
export const ACTION_REGISTRY = {
  entityList: {
    ...
    triggerProps: {
      ...
      onTriggerStart: (field, value) =>
        console.log("Action Triggered... ", field, value),
      onTriggerEnd: (field, value) =>
        console.log("Action Triggered... ", field, value),
      data: {},
      disabled: null,
    },
    ...
    commandType: null,
    commandProps: {
      onCommandExecute: (command, payload) =>
        console.log("Command Executed...", command, payload),
      onCommandSuccess: (command, commandResults) =>
        console.log("Command Success...", commandResults),
      onCommandError: (command, error) =>
        console.log("Command Error...", error),
      commandCallback: (commandUpdate) =>
        console.log("Command Results...", commandUpdate),
    },
    ...
    presentationWrapperProps: {
      ...
      onPresentationEnd: (presentationResults) =>
        console.log("Presentation Ended...", presentationResults),
