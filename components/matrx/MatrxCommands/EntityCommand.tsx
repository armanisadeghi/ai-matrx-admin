...
import {
  showConfirmDialog,
  showErrorToast,
} from "@/components/matrx/MatrxCommands/helpers";
import { cn } from "@/lib/utils";
import type { AppDispatch } from "@/lib/redux/store";
import { useEntityTools } from "@/lib/redux/entity/hooks/coreHooks";

// Entity-specific command context
export interface EntityCommandContext<
  TEntity extends EntityKeys,
> extends TableCommandContext {
  entityKey: TEntity;
...
export function createEntityCommand<TEntity extends EntityKeys>(
  ...
  }> = ({ index, data, className, onExecute }) => {
...
export const createEntityCommands = <TEntity extends EntityKeys>(
  entityKey: TEntity,
) => ({
...
export type EntityCommandName =
  | keyof ReturnType<typeof createEntityCommands>
  | string;
...
const defaultEntityCommands: EntityCommandName[] = [
  "expand",
  "view",
  "edit",
  "delete",
...
export interface QuickEntityCommandGroupProps<
  TEntity extends EntityKeys,
