...
import { EntityQuickReferenceAccordion } from "../prewired-components/quick-reference/EntityQuickReferenceAccordion";
import { EntityQuickReferenceAccordionEnhanced } from "../prewired-components/quick-reference/EntityQuickReferenceAccordionEnhanced";
import EntityQuickReferenceCards from "../prewired-components/quick-reference/EntityQuickReferenceCards";
import EntityQuickReferenceCardsEnhanced from "../prewired-components/quick-reference/EntityQuickReferenceCardsEnhanced";
import EntityQuickReferenceList from "../prewired-components/quick-reference/EntityQuickReferenceList";
import EntityQuickReferenceSelect from "../prewired-components/quick-reference/EntityQuickReferenceSelect";
...
const PreWiredEntityRecordHeader: React.FC<PreWiredEntityRecordHeaderProps> = ({
  ...
  const QuickReferenceComponent = React.useMemo(() => {
    ...
    const components = {
      ...
      accordionEnhanced: (
        <EntityQuickReferenceAccordionEnhanced {...commonProps} />
      ),
    ...
    <CardHeader className={className}>
      ...
      >
        ...
        {selectedEntity && (
          <div
            ref={rightColumnRef}
            className={cn(layout === "sideBySide" ? "flex-1" : "w-full")}
          >
