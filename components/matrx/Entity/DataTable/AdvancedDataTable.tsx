...
export function AdvancedDataTable<TEntity extends EntityKeys>({
  ...
  const [selectedRow, setSelectedRow] =
    React.useState<EntityDataWithId<EntityKeys> | null>(null);
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                ...
                >
                  ...
                  {mergedOptions.showCheckboxes && (
                    <TableCell
                      className={cn("p-0", densityConfig[density || "normal"])}
                    >
                      <Checkbox
                  ...
                  {row.getVisibleCells().map((cell) => (
                    <TableCell
                      ...
                      className={cn(
                        ...
                        getColumnMeta(cell.column.columnDef)?.align === "right"
                          ? "text-right"
                          : "",
                        getColumnMeta(cell.column.columnDef)?.align === "center"
                          ? "text-center"
                          : "",
                      )}
                    >
              ...
              <TableRow>
                <TableCell
                  colSpan={
                    ...
                    (mergedOptions.showCheckboxes ? 1 : 0)
                  }
