...
export function DataTable<TEntity extends EntityKeys>({
  ...
  const [selectedRow, setSelectedRow] =
    React.useState<EntityData<TEntity> | null>(null);
  const [isModalOpen, setIsModalOpen] = React.useState(false);
  const [activeTab, setActiveTab] = React.useState<string>("view");

  const handleAction = React.useCallback(
    (actionName: string, row: Row<EntityDataWithId<TEntity>>) => {
                ...
                <TableRow
                  ...
                  onClick={(e) => {
                    ...
                    const isCheckboxCell =
                      targetElement.closest(".checkbox-cell");
      ...
      <div className="flex items-center justify-between py-4">
        <div className="flex items-center space-x-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline">
                Rows per page: {paginationInfo.pageSize}{" "}
