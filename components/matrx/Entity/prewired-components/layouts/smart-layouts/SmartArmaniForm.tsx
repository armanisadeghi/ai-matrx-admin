...
export const SmartArmaniForm: React.FC<SmartArmaniFormProps> = (props) => {
  ...
  const { getNativeFieldComponent, getRelationshipFieldComponent } =
    useFieldRenderer(selectedEntity, effectiveRecordId, unifiedLayoutProps);
      ...
      <ShadowWrapper>
        ...
        >
            ...
            {isSinglePage ? (
              ...
              <>
                {allRenderedFields.length > 0 &&
                  currentStep < allRenderedFields.length && (
                    <>
                      <motion.h2
                        className={cn(
          ...
          >
            ...
            {isSinglePage ||
            (allRenderedFields.length > 0 &&
              currentStep === allRenderedFields.length - 1) ? (
              <EntityButton
                type="submit"
