...
export const SmartLayoutSideBySide: React.FC<UnifiedLayoutProps> = (
  unifiedLayoutProps,
) => {
  ...
  const splitRatio =
    unifiedLayoutProps.dynamicLayoutOptions.formStyleOptions.splitRatio;
  ...
  const { measurements, getRef, pauseMeasurements, resumeMeasurements } =
