...
const ArmaniLayout: React.FC<EntityLayoutProps> = React.memo(
  ({
    ...
    const [selectedEntity, setSelectedEntity] = useState<EntityKeys | null>(
      null,
    );
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="p-0">
                      <ScrollArea
                        className={cn(densityConfig[density].maxHeight, "px-4")}
                      >
                        {QuickReferenceComponent}
                      </ScrollArea>
                    </CardContent>
