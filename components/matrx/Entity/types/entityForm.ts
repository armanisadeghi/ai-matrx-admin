...
import type { FormState } from "@/components/matrx/ArmaniForm/ArmaniForm";
...
const sampleEntry = {
  ...
  databaseTable: "tool",
  description:
    '"Parameters" field for tool. This is an optional field. Your entry must be an object data type.',
};
...
export type ModalOnSubmit =
  | (() => void)
  | ((formData: EntityFormState) => void);

export interface EntityFormModalProps extends Omit<
  Partial<EntityFormProps>,
  "onSubmit"
> {
  isOpen?: boolean;
  onClose?: () => void;
...
export interface EntityTabModalProps extends Partial<
  Omit<EntityFormProps, "onSubmit">
> {
  isOpen?: boolean;
  onClose?: () => void;
  onSubmit?: ModalOnSubmit;
