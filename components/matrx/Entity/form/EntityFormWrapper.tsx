...
import FlexAnimatedForm from "@/components/matrx/AnimatedForm/FlexAnimatedForm";
  ...
  const formProps: FlexEntityFormProps = useMemo(() => {
    ...
    return {
      ...
      onUpdateField: (name: string, value: any) => {
        if (!entityFormState.activeRecord || !entityFormState.matrxRecordId)
          return;
        entityFormState.updateRecord(
          entityFormState.matrxRecordId,
          (updatedData) => {
