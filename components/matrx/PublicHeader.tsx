...
export function PublicHeader() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm">
            <div className="w-full px-3 h-9 flex items-center justify-between">
                {/* Logo */}
                <Link 
                    href="/" 
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <Link href="/canvas/discover" className="hidden sm:block">
                        <Button 
                            variant="ghost" 
                            size="sm"
                            className="h-7 px-2 text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-800"
                        >
                            Discover
                        </Button>
                    </Link>
