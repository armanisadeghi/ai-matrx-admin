                                        ...
                                        <li key={`primary-${index}`}>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <a
                                                        href={link.href}
                                                        className={`relative flex items-center px-2 py-2 rounded-lg transition-all duration-200 ease-in-out transform hover:scale-[1.02] active:scale-[0.98] ${isLinkActive(link.href)
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            className={`absolute left-9 text-xs whitespace-nowrap transition-all duration-300 ease-in-out ${isSidebarCollapsed
                        ...
                        {shouldShowSecondaryLinks && secondaryLinks.length > 0 && (
                            ...
                            >
                                <h3
                                    ...
                                    className={`px-1 mb-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider transition-all duration-300 ease-in-out cursor-pointer hover:text-gray-700 dark:hover:text-gray-300 flex-shrink-0 ${isSidebarCollapsed
                                            ? "opacity-0 translate-x-2 pointer-events-none"
                                            : "opacity-100 translate-x-0"
                                        }`}
                                >
                            ...
                            <div className="flex-shrink-0 mb-1">
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Link
                                            href="/administration"
                                            className={`relative flex items-center px-2 py-2 rounded-lg transition-all duration-200 ease-in-out transform hover:scale-[1.02] active:scale-[0.98] ${isLinkActive("/administration")
