...
//
//
// // Dummy content that needs to be replaced with actual content
//
//
//
// export const Logo = () => {
...
//         >
//             <div
//                 className="h-5 w-6 flex-shrink-0 rounded-bl-sm rounded-br-lg rounded-tl-lg rounded-tr-sm bg-black dark:bg-white"/>
//             <motion.span
//                 initial={{opacity: 0}}
//                 animate={{opacity: 1}}
