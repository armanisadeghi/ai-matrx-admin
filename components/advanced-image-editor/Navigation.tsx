...
function Navbar({ className }: { className?: string }) {
  ...
  const editorOptions = [
      ...
      subLinks: [
        {
          ...
          href: "/advanced-image-editor/layer-management",
        },
        {
          title: "Advanced Filters",
          href: "/advanced-image-editor/advanced-filters",
        },
        // Add more sub-links as needed
      ],
    },
      ...
      subLinks: [
        {
          ...
          href: "/extended-image-editor/batch-processing",
        },
    ...
    },
    {
      title: "AI Assisted",
      description:
        "AI-powered old-tools to enhance your image editing workflow.",
    ...
    },
    {
      ...
      subLinks: [
        {
          title: "All Tools",
          href: "/full-featured-image-editor/all-old-tools",
        },
        {
          title: "Custom Workspaces",
          href: "/full-featured-image-editor/custom-workspaces",
        },
        // Add more sub-links as needed
      ],
    },
