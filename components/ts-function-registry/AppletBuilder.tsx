    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full p-2 mb-2 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200"
          placeholder="Applet Name"
        />
        <textarea
          value={applet.description || ''}
          onChange={e => setApplet(prev => ({ ...prev, description: e.target.value }))}
          className="w-full p-2 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200"
      ...
      <div className="mb-4">
        ...
        <div className="flex">
          <select 
            className="flex-1 p-2 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 mr-2"
      ...
      <div className="mb-4">
        ...
        {applet.steps.map((step, index) => {
          ...
          return (
            <div 
              key={step.id} 
              className="mb-3 p-3 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800"
            >
