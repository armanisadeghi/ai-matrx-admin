...
const tabCategories: {
  ...
  },
  {
    ...
    description: "Text generation settings",
  },
  {
    value: "coding",
    label: "Coding",
  ...
  },
  {
    ...
    description: "Flashcard study settings",
  },
  {
    value: "playground",
    label: "Playground",
...
const PreferencesPage = () => {
  ...
  const initialTab =
    tabParam && validTabs.includes(tabParam) ? tabParam : "display";
  ...
  const handleSave = () => {
    ...
    // transparently (debounced ≤250ms). This handler just clears the dirty
    // indicator — the actual Supabase upsert has already happened (or will
    // within a couple frames of the last edit).
