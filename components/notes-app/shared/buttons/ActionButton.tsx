...
export const NewButton = () => {
    const { handleAddNote, selectedFolderId } = useNotesManagerContext();
...
export const EditButton = () => {
    const { isEditing, toggleEditMode, currentNote } = useNotesManagerContext();
    return (
        <IconButton
...
export const SaveButton = () => {
    const { handleManualSave } = useNotesManagerContext();
    return <IconButton icon={Save} variant="secondary" onClick={handleManualSave} />;
};

export const CopyButton = () => {
    const { handleCopyNote, currentNote } = useNotesManagerContext();
    return (
        <IconButton
            icon={Copy}
            variant="ghost"
...
export const DeleteButton = () => {
    const { handleNoteDelete, currentNote } = useNotesManagerContext();
    return (
        <IconButton
            icon={Trash2}
            variant="destructive"
