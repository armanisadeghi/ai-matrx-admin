...
export function SocketHeaderFull({ 
    ...
    return (
        <div className="py-2 px-3 space-y-1 bg-gray-200 dark:bg-gray-900 border-3 border-gray-300 dark:border-gray-600 rounded-3xl relative">
            ...
            <div className="grid md:grid-cols-4 gap-3">
                ...
                <div>
                    <ActiveConnectionSelector selectedConnectionId={selectedConnectionId} onConnectionSelect={handleConnectionSelect} />
                </div>
                {/* Service & Task Selection (using the new combined component) */}
                <div className="col-span-3">
                    <ServiceTaskSelector connectionId={selectedConnectionId} onTaskCreate={handleTaskCreate} />
                </div>
            </div>
        </div>
    );
