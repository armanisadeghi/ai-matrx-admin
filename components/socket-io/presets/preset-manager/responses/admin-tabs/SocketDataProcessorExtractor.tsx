...
interface SocketDataProcessorExtractorProps {
  taskId: string | null;
 ...
 */
export const SocketDataProcessorExtractor: React.FC<SocketDataProcessorExtractorProps> = ({
  taskId,
  onTaskIdChange,
  isExecuting = false,
  error,
        ...
        <CardContent className="h-full p-0 overflow-hidden">
          {hasDataResponse ? (
            <div className="h-full">
              <ProcessorExtractor jsonData={dataResponse} configKey={taskId} />
            </div>
          ) : (
            <div className="h-full flex items-center justify-center text-gray-500 dark:text-gray-400">
              <div className="text-center">
...
export default SocketDataProcessorExtractor; 