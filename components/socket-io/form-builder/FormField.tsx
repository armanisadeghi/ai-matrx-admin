...
import { SocketTaskInput, SocketTaskSwitch } from "./field-components";
...
const FormField: React.FC<FormFieldProps> = ({
    ...
    React.useEffect(() => {
        if (testMode && fieldDefinition.TEST_VALUE !== undefined && value !== fieldDefinition.TEST_VALUE) {
            // Use a microtask to ensure this is outside the current render cycle
            Promise.resolve().then(() => {
                onChange(fullPath, fieldDefinition.TEST_VALUE);
            });
        }
    }, [testMode, fieldDefinition.TEST_VALUE, fullPath, onChange, value]);
    ...
    const getComponentType = (): FieldType => {
        if (fieldDefinition.COMPONENT) {
            ...
            const componentLower = fieldDefinition.COMPONENT.toLowerCase();
            if (VALID_COMPONENTS.includes(componentLower)) {
                return componentLower as FieldType;
            } else {
                console.warn(`Component type "${fieldDefinition.COMPONENT}" is not supported. Falling back to default.`);
            }
        }
        ...
        if (
            ...
            (fieldDefinition.DATA_TYPE === null && typeof fieldDefinition.DEFAULT === "boolean")
        ) {
            return "switch";
        }

        if (fieldDefinition.DATA_TYPE === "object") {
            return "jsoneditor";
        }
    ...
    const getComponentProps = () => {
        ...
        if (fieldDefinition.COMPONENT_PROPS) {
    ...
    if (fieldDefinition.DATA_TYPE === "array") {
        ...
        if (componentType === "multifileupload") {
            ...
            const placeholder = fieldDefinition.DESCRIPTION || formatPlaceholder(fieldName);
    ...
    if (fieldDefinition.REFERENCE) {
        if (typeof value !== "object" || value === null) value = fieldDefinition.DEFAULT || {};
        return (
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                            <Checkbox
                                ...
                                onBlur={() => onBlur(fullPath, fieldDefinition, value)}
                                {...componentProps}
                            />
                            <Icon className="w-4 h-4 mr-2 text-slate-500" />
                            <Label className="text-sm text-gray-500 dark:text-gray-400">{placeholder}</Label>
            ...
            case "slider":
                ...
                const sliderValue =
                    typeof value === "number"
                        ...
                        ? typeof fieldDefinition.DEFAULT === "number"
                            ? fieldDefinition.DEFAULT
                            : 0
                        : 0;
                ...
                return (
                    <div className="flex flex-col gap-2">
                        ...
                        <Slider
                            ...
                            onValueCommit={(val) => onBlur(fullPath, fieldDefinition, val[0])}
                ...
                return (
                    <div className="flex flex-col gap-2">
                        <Select
                            ...
                            onOpenChange={() => {
                                if (value) onBlur(fullPath, fieldDefinition, value);
                            }}
                        >
                ...
                return (
                    <div className="flex flex-col gap-2">
                        ...
                        <RadioGroup
                            ...
                            onValueChange={(val) => {
                                onChange(fullPath, val);
                                onBlur(fullPath, fieldDefinition, val);
                            }}
                            className="space-y-1"
                        >
                            {componentProps.options?.map((option: { label: string; value: string }) => (
                        ...
                        <textarea
                            ...
                            onBlur={(e) => {
                                ...
                                try {
                                    ...
                                    onBlur(fullPath, fieldDefinition, e.target.value);
                                } catch (err) {
