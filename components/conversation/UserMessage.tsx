...
import { Check, Copy, ChevronDown, ChevronUp, FileText, Image as ImageIcon, Music, Youtube, Globe, Paperclip } from 'lucide-react';
...
export function UserMessage({ message, onContentChange, compact = false }: UserMessageProps) {
    ...
    const textContent = useMemo(
        () => (hasEmbeddedResources ? extractMessageWithoutResources(message.content) : message.content),
        [message.content, hasEmbeddedResources]
    );
