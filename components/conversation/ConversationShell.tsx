...
import type { ConversationInputProps } from '@/components/conversation/ConversationInput';
            ...
            <div className="flex flex-1 overflow-hidden min-h-0">
                ...
                {(enableInlineCanvas || enableCanvas) && (
                    <div className="flex-shrink-0 w-1/2 min-w-[300px] border-l border-border overflow-hidden">
                        <Suspense fallback={<div className="h-full flex items-center justify-center text-muted-foreground text-sm">Loading canvas…</div>}>
                            <ResizableCanvas>
                                <CanvasRenderer />
                            </ResizableCanvas>
                        </Suspense>
