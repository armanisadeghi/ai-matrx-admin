    ...
    >
      ...
      <div className="p-4 border-t border-border bg-gray-50 dark:bg-gray-800">
        <div className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
          ...
          <p>
            <strong>Tip:</strong> Click any action to insert its template into
            your current message. The AI will then generate the content in a
            format that opens in the canvas panel.
          </p>
        </div>
      </div>
    </div>
