...
import { SmartNewButton } from "@/components/matrx/Entity/prewired-components/layouts/smart-layouts/smart-actions/core-buttons/SmartNewButton";
...
export default function BrokerSidebar({
  ...
  const { selectedRecordIds, handleToggleSelection, setSelectionMode } =
    useQuickRef(entityName);
  ...
  const getSelectedRecordsWithKeys = () => {
    return selectedRecordIds.reduce(
      (acc, recordId) => {
