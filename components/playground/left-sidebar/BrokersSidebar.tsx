...
import { QuickReferenceRecord } from "@/app/entities/quick-reference/dynamic-quick-ref/QuickRefSearchableSelect";
...
const layoutProps = getUpdatedUnifiedLayoutProps(
  initialLayoutProps,
  {
    dynamicPanelsPage: {
      density: "compact",
