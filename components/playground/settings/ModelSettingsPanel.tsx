...
const ModelSettingsPanel: React.FC<CockpitPanelProps> = ({
  playgroundControls,
}) => {
  ...
  const { generateTabs, createNewSettingsData, recipeAgentSettingsHook } =
    playgroundControls.aiCockpitHook;
  ...
  return (
    <div className="h-full flex flex-col bg-textured" ref={ref}>
      <Tabs
