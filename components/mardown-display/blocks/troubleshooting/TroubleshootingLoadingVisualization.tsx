    ...
    <div className="w-full max-w-5xl mx-auto py-8">
      <div className="bg-gradient-to-br from-red-100 via-orange-50 to-yellow-100 dark:from-red-950/40 dark:via-orange-950/30 dark:to-yellow-950/40 rounded-2xl p-8 shadow-lg border-2 border-red-200 dark:border-red-800/50">
          ...
          {[
            ...
            <div key={index} className="space-y-3 animate-pulse" style={{ animationDelay: `${step.delay}ms` }}>
              <div className="flex items-center gap-4">
                <div className={`p-3 ${step.bgColor} rounded-lg border-border`}>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          {[1, 2, 3, 4].map((issue) => (
            <div key={issue} className="bg-textured/50 rounded-lg p-4 border-border animate-pulse" style={{ animationDelay: `${issue * 150}ms` }}>
              {/* Issue Header */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div key={index} className="bg-textured/50 rounded-lg p-3 border-border animate-pulse" style={{ animationDelay: `${index * 100}ms` }}>
