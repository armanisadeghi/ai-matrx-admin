                    ...
                    <CardContent className="p-6">
                        <Tabs defaultValue="layout" className="w-full">
                            ...
                            <TabsContent value="background" className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    {renderColorSelect("Background Color", config?.backgroundColor?.base || "bg-background", (value) =>
                                        setConfig({
                                            ...config,
                                            backgroundColor: { ...config.backgroundColor, base: value },
                                        })
                                    )}
                                    {renderColorSelect("Dark Mode Background", config.backgroundColor?.dark || "dark:bg-background", (value) =>
                                        setConfig({
                                            ...config,
                            ...
                            <TabsContent value="text" className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    {renderColorSelect("Text Color", config.textColor?.base || "text-foreground", (value) =>
                                        setConfig({
                                            ...config,
                                            textColor: { ...config.textColor, base: value },
                                        })
                                    )}
                                    {renderColorSelect("Dark Mode Text", config.textColor?.dark || "dark:text-foreground", (value) =>
                                        setConfig({
                                            ...config,
                            ...
                            <TabsContent value="border-color" className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    {renderColorSelect("Border Color", config.borderColor?.base || "border-border", (value) =>
                                        setConfig({
                                            ...config,
                                            borderColor: { ...config.borderColor, base: value },
                                        })
                                    )}
                                    {renderColorSelect("Dark Mode Border", config.borderColor?.dark || "dark:border-border", (value) =>
                                        setConfig({
                                            ...config,
                            ...
                            <TabsContent value="hover" className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    {renderColorSelect("Hover Background", config?.hoverColor?.background?.base || "hover:bg-background", (value) =>
                                        setConfig({
                                            ...config,
                                            hoverColor: {
                                                ...config.hoverColor,
                                    ...
                                    {renderColorSelect("Dark Mode Hover Background", config?.hoverColor?.background?.dark || "dark:hover:bg-background", (value) =>
                                        setConfig({
                                            ...config,
                                            hoverColor: {
                                                ...config.hoverColor,
                                    ...
                                    {renderColorSelect("Hover Text", config?.hoverColor?.text?.base || "hover:text-foreground", (value) =>
                                        setConfig({
                                            ...config,
                                            hoverColor: {
                                                ...config.hoverColor,
                                    ...
                                    {renderColorSelect("Dark Mode Hover Text", config?.hoverColor?.text?.dark || "dark:hover:text-foreground", (value) =>
                                        setConfig({
                                            ...config,
                                            hoverColor: {
                                                ...config.hoverColor,
