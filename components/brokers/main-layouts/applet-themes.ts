...
export type AppletThemeName = "pinkBlue" | "professional" | "default";
export type AppletThemeRecord = Record<AppletThemeName, AppletTheme>;

export const APPLET_THEMES: AppletThemeRecord = {
    pinkBlue: {
        primaryColor: "pink",
        secondaryColor: "cyan",
        accentColor: "blue",
