                ...
                <div className="space-y-2 pt-4">
                    <Tabs defaultValue="monitor" className="w-full">
                        ...
                        <TabsContent value="events" className="space-y-4">
                            ...
                            <ActiveEventsPanel onSelectEvent={handleSelectEvent} selectedEventId={selectedEventId} />
                        </TabsContent>

                        <TabsContent value="monitor" className="space-y-4">
                            <div className="flex flex-col space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Event ID Selection</div>
                                    <Button
                                        variant="outline"
                                        size="sm"
                                ...
                                {isCustomMode ? (
                                    ...
                                    <div className="flex flex-col space-y-2">
                                        <div className="text-xs text-gray-600 dark:text-gray-400">Enter a custom event ID:</div>
                                        <div className="flex items-center space-x-4">
                                            ...
                                            />
                                            {customEventId && <EventStatusIndicator eventId={customEventId} />}
                                        </div>
                                    </div>
                                ) : (
                                    ...
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            {selectedEventId && <EventStatusIndicator eventId={selectedEventId} />}
                                        </div>
                                    </div>
                                )}
                            </div>

                            {displayEventId && <StreamMonitorPanel eventId={displayEventId} />}
                        </TabsContent>
                    </Tabs>
                </div>
            </AccordionWrapper>
