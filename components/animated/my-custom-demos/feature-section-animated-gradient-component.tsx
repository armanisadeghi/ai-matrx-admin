...
const FeatureSectionAnimatedGradientComponents = (
    {
        title,
        description,
        icon,
        ...
        index: number;
        link?: string;
        onClick?: () => void;  // Add this new prop type
    }) => {
    ...
    const containerClass = cn(
        ...
        index < 4 && "lg:border-b",
        (link || onClick) && "cursor-pointer"  // Modified this line
    );
...
export default FeatureSectionAnimatedGradientComponents;
