...
export default function AnimatedMenu({ items }: AnimatedMenuProps) {
...
// Tasks: These need to do something.
// Consider tying them to Actions maybe so the action part is automated.

// Usage:
// <AnimatedMenu items={['Home', 'About', 'Services', 'Contact']} />
