...
const AdminIndicator = ({ user, socketConnected = false, socketUrl = "" }: AdminIndicatorProps) => {
    ...
    const SmallIndicator = () => {
        // This function will be used for drag initiation on the container and icons
                ...
                <div className="flex items-center gap-1">
                    <div
                        className={`w-2 h-2 rounded-full ${
                            socketUrl === "Not connected" || socketUrl === "Connection error"
                                ? "bg-red-500"
    ...
    const MediumIndicator = () => (
        ...
        >
            <div className="flex justify-between items-center px-2 py-1 bg-slate-900">
                ...
                <div className="flex items-center gap-1">
                    <div className="cursor-move p-1 rounded hover:bg-slate-700" onMouseDown={handleMouseDown}>
                        <Move size={14} />
                    </div>
                    <button
                        onClick={(e) => {
    ...
    // The content for the large panel
    const LargeControls = () => (
            ...
            <div className="p-4">
                <div className="grid grid-cols-2 gap-3 mb-4">
                    ...
                    <div className="bg-slate-700 p-3 rounded col-span-2">
                        ...
                        <div
                            className={`text-sm font-semibold ${socketUrl.includes("localhost") ? "text-yellow-400" : "text-blue-400"}`}
                            title={socketUrl}
                        >
                            {socketUrl}
                        </div>
    ...
    const renderIndicator = () => {
        switch (size) {
            ...
            case "large":
                // For the large size, we return the MatrxDynamicPanel without any positioning
                return (
                    <MatrxDynamicPanel
