// // File Location: types/AutomationCoreTypes.ts
//
...
//     | 'null' | 'undefined' | 'any' | 'function' | 'symbol' | 'union'
//     | 'bigint' | 'date' | 'map' | 'set' | 'tuple' | 'enum' | 'intersection'
//     | 'literal' | 'void' | 'never';
//
...
//     'custom';
//
// export type FieldDataType = RequiredNameFormats | OptionalNameFormats;
//
