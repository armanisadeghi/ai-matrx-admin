// @ts-nocheck
// Form context + SmartForm (split from fieldComponentExample to avoid SmartField <-> useForm cycle)
...
import { setFormMode } from "../fieldSlice";
...
const FormContent: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const canSubmit = isDirty && isValid && (mode === "edit" || mode === "create");
