...
export const useSchema = () => {
  ...
  const getFieldNameMappingForEntity = (entityName: EntityKeys) => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldNameMappingForEntity(state, entityName),
      [entityName],
    );
    return useAppSelector(selector);
  };
  ...
  const getEntityPrimaryKeyField = (
    entityName: EntityKeys,
  ): string | undefined => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectEntityPrimaryKeyField(state, entityName),
      [entityName],
    );
    return useAppSelector(selector);
  };
  ...
  const getEntityFieldNameToDatabaseMap = (
    entityName: EntityKeys,
  ): Record<string, string> => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectEntityFieldNameToDatabaseMap(state, entityName),
      [entityName],
    );
    return useAppSelector(selector);
  };
  ...
  const getEntityAnyName = (
    entityName: EntityKeys,
    format: NameFormat,
  ): string => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectEntityAnyName(state, { entityName, format }),
      [entityName, format],
    );
    return useAppSelector(selector);
  };
  ...
  const getFieldDatabaseName = (
    entityName: EntityKeys,
    fieldName: string,
  ): string => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldDatabaseName(state, { entityName, fieldName }),
      [entityName, fieldName],
    );
    return useAppSelector(selector);
  };
  ...
  const getFieldBackendName = (
    entityName: EntityKeys,
    fieldName: string,
  ): string => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldBackendName(state, { entityName, fieldName }),
      [entityName, fieldName],
    );
    return useAppSelector(selector);
  };
  ...
  const getFieldFrontendName = (
    entityName: EntityKeys,
    fieldName: string,
  ): string => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldFrontendName(state, { entityName, fieldName }),
      [entityName, fieldName],
    );
    return useAppSelector(selector);
  };
  ...
  const getFieldPrettyName = (
    entityName: EntityKeys,
    fieldName: string,
  ): string => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldPrettyName(state, { entityName, fieldName }),
      [entityName, fieldName],
    );
    return useAppSelector(selector);
  };
  ...
  const getAllFieldPrettyNames = (
    entityName: EntityKeys,
  ): Record<string, string> => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectAllFieldPrettyNames(state, { entityName }),
      [entityName],
    );
    return useAppSelector(selector);
  };
  ...
  const getFieldAnyName = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldAnyName(state, { entityName, fieldName, format }),
  ...
  const getFieldSchema = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectFieldSchema(state, { entityName, fieldName }),
      [entityName, fieldName],
    );
    return useAppSelector(selector);
  };
  ...
  const replaceKeysInObject = (data: any, keyMapping: KeyMapping): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectReplaceKeysInObject(state, data, keyMapping),
      [data, keyMapping],
    );
    return useAppSelector(selector);
  };
  ...
  const getDatabaseConversion = (entityName: EntityKeys, data: any): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectDatabaseConversion(state, { entityName, data }),
      [entityName, data],
    );
    return useAppSelector(selector);
  };
  ...
  const getBackendConversion = (entityName: EntityKeys, data: any): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectBackendConversion(state, { entityName, data }),
      [entityName, data],
    );
    return useAppSelector(selector);
  };
  ...
  const getPrettyConversion = (entityName: EntityKeys, data: any): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectPrettyConversion(state, { entityName, data }),
      [entityName, data],
    );
    return useAppSelector(selector);
  };
  ...
  const getAnyFieldMapping = (
    entityName: EntityKeys,
    format: NameFormat,
  ): Record<string, string> => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectAnyFieldMapping(state, entityName, format),
      [entityName, format],
    );
    return useAppSelector(selector);
  };
  ...
  const getAnyObjectFormatConversion = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectAnyObjectFormatConversion(state, { entityName, data, format }),
  ...
  const getUnknownToAnyObjectFormatConversion = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectUnknownToAnyObjectFormatConversion(state, {
          entityAlias,
          data,
          targetFormat,
        }),
  ...
  const getFrontendConversion = (entityName: EntityKeys, data: any): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectFrontendConversion(state, { entityName, data }),
      [entityName, data],
    );
    return useAppSelector(selector);
  };
  ...
  const getCanonicalConversion = (entityName: EntityKeys, data: any): any => {
    const selector = useMemo(
      () => (state: RootState) =>
        selectCanonicalConversion(state, { entityName, data }),
      [entityName, data],
    );
    return useAppSelector(selector);
  };
  ...
  const getQueryDatabaseConversion = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectQueryDatabaseConversion(state, { entityName, options }),
      [entityName, options],
    );
    return useAppSelector(selector);
  };
  ...
  const getPayloadOptionsDatabaseConversion = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectPayloadOptionsDatabaseConversion(state, { entityName, options }),
      [entityName, options],
    );
    return useAppSelector(selector);
  };
  ...
  const getUnifiedQueryDatabaseConversion = (
    ...
    const selector = useMemo(
      () => (state: RootState) =>
        selectUnifiedQueryDatabaseConversion(state, { entityName, options }),
      [entityName, options],
    );
    return useAppSelector(selector);
  };
