 ...
 */
export const saveContainerThunk = createAsyncThunk<ContainerBuilder, string, { state: RootState }>(
...
export const saveContainerAndUpdateAppletThunk = createAsyncThunk(
    ...
    async ({ containerId, appletId }: { containerId: string; appletId: string }, { dispatch, rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(error.message || "Failed to save container and update applet");
        }
    }
);

// Create a new container
export const createContainerThunk = createAsyncThunk<ContainerBuilder, Partial<ContainerBuilder>, { state: RootState }>(
...
// Delete a container
export const deleteContainerThunk = createAsyncThunk<void, string, { state: RootState }>(
...
export const removeFieldThunk = createAsyncThunk<void, { containerId: string; fieldId: string }, { state: RootState }>(
...
export const recompileContainerThunk = createAsyncThunk<ContainerBuilder, string, { state: RootState }>(
...
export const fetchContainersThunk = createAsyncThunk<ContainerBuilder[], void, { state: RootState }>(
...
export const fetchContainerByIdThunk = createAsyncThunk<ContainerBuilder, string, { state: RootState }>(
 ...
 */
export const setActiveContainerWithFetchThunk = createAsyncThunk<void, string, { state: RootState }>(
