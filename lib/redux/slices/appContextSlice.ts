...
const appContextSlice = createSlice({
    ...
    reducers: {
         ...
         */
        setFullContext: (state, action: PayloadAction<Partial<AppContextState>>) => {
...
export const selectOrganizationId = (state: StateWithAppContext): string | null =>
...
export const selectConversationId = (state: StateWithAppContext): string | null =>
    state.appContext.conversation_id;

/** Memoized selector - returns the full context object */
export const selectAppContext = createSelector(
    (state: StateWithAppContext) => state.appContext,
    (ctx) => ({ ...ctx })
);
