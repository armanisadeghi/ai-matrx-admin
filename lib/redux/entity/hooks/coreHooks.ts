...
export const useEntityData = (entityKey: EntityKeys) => {
  ...
  const effectiveRecords = useAppSelector(
    selectors.selectAllEffectiveRecordsWithKeys,
  );
...
export const useEntityAllData = (entityKey: EntityKeys) => {
  ...
  const allRecordsWithKeys = useAppSelector((state) =>
    selectors.selectAllEffectiveRecordsWithKeys(state),
  );
