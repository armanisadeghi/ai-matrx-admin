...
export type { ExtractType } from "@/types/automationSchemaPrimitives";
...
export type EntityFieldWithValue<TEntity extends EntityKeys> = {
  [TField in keyof AutomationEntity<TEntity>["entityFields"]]: Omit<
    AutomationEntity<TEntity>["entityFields"][TField],
    "typeReference"
  > & {
...
export type EntityDataWithId<TEntity extends EntityKeys> =
  EntityData<TEntity> & {
...
export type EntityRecordArray<TEntity extends EntityKeys> =
  EntityData<TEntity>[];

export type EntityRecordMap<TEntity extends EntityKeys> = Record<
  MatrxRecordId,
  EntityData<TEntity>
>;
