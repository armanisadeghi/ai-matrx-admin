...
export function entityActionCreators(entityName: string) {
...
export const createEntityActions = (entityName: string) => {
    ...
    return {
        ...
        fetchPaginatedRequest: (page: number, pageSize: number, options: QueryOptions<any>) => ({ type: actionTypes.FETCH_PAGINATED_REQUEST, payload: { page, pageSize, options } }),
        fetchPaginatedSuccess: (data: any[], total: number) => ({ type: actionTypes.FETCH_PAGINATED_SUCCESS, payload: { data, total } }),
        fetchPaginatedFailure: (error: Error) => ({ type: actionTypes.FETCH_PAGINATED_FAILURE, payload: error }),

        fetchPaginatedDirectlyRequest: (options: QueryOptions<any>) => ({ type: actionTypes.FETCH_PAGINATED_REQUEST, payload: options }),
        fetchPaginatedDirectlySuccess: (data: any[], total: number) => ({ type: actionTypes.FETCH_PAGINATED_SUCCESS, payload: { data, total } }),
        fetchPaginatedDirectlyFailure: (error: Error) => ({ type: actionTypes.FETCH_PAGINATED_FAILURE, payload: error }),


        fetchByPrimaryKeyRequest: (primaryKey: string | number) => ({ type: actionTypes.FETCH_BY_PRIMARY_KEY_REQUEST, payload: primaryKey }),
        ...
        fetchRelatedRequest: (relatedKey: string | number) => ({ type: actionTypes.FETCH_RELATED_REQUEST, payload: relatedKey }),
        ...
        fetchByFieldRequest: (field: string, value: any) => ({ type: actionTypes.FETCH_BY_FIELD_REQUEST, payload: { field, value } }),
        ...
        fetchPkAndDisplayFieldsSuccess: (data: any[]) => ({ type: actionTypes.FETCH_PK_AND_DISPLAY_FIELDS_SUCCESS, payload: data }),
        fetchPkAndDisplayFieldsFailure: (error: Error) => ({ type: actionTypes.FETCH_PK_AND_DISPLAY_FIELDS_FAILURE, payload: error }),
