...
export interface WorkflowNode {
    ...
    created_at?: string; // Auto-generated by the database (Never set in React.)
    updated_at?: string; // Auto-generated by the database (Never set in React.)
    user_id?: string; // UUID
    ...
    is_public?: boolean; // Boolean, nullable
    authenticated_read?: boolean; // Boolean, nullable
    public_read?: boolean; // Boolean, nullable
}
