...
// Narrowing helpers
export const isTextBlock     = (b: CanonicalBlock): b is TextBlock      => b.type === 'text';
export const isThinkingBlock = (b: CanonicalBlock): b is ThinkingBlock  => b.type === 'thinking';
export const isMediaBlock    = (b: CanonicalBlock): b is MediaBlock      => b.type === 'media';
export const isToolCallBlock = (b: CanonicalBlock): b is ToolCallBlock   => b.type === 'tool_call';
export const isErrorBlock    = (b: CanonicalBlock): b is ErrorBlock      => b.type === 'error';
 ...
 * raw StreamEvent[], CxMessage[], or ToolCallObject[].
 */
