...
import { NEW_CONVERSATION_ID, CHAT_RELATIONSHIP_BASE_CONFIG, CHAT_CREATE_BASE_CONFIG, NEW_CHAT_PARAMS } from "@/constants/chat";
...
export function useChatRelationship(convoId: string) {
    ...
    }, [isChatReady, isConversationReady, isMessageReady, isParentLoadingRef.current, createNewMessage, matchingChildRecordsCount]);
