...
const adminsEntityOverrides: EntityOverrides<'admins'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
const organizationMembersEntityOverrides: EntityOverrides<'organizationMembers'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
const organizationsEntityOverrides: EntityOverrides<'organizations'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
const permissionsEntityOverrides: EntityOverrides<'permissions'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
const workflowDataEntityOverrides: EntityOverrides<'workflowData'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
const workflowNodeDataEntityOverrides: EntityOverrides<'workflowNodeData'> = {
    schemaType: null,
    entityName: null,
    uniqueTableId: null,
    uniqueEntityId: null,
...
export const ENTITY_OVERRIDES: Record<EntityKeys, EntityOverrides<EntityKeys>> = {
    ...
    permissions: permissionsEntityOverrides,
    ...
    workflowData: workflowDataEntityOverrides,
    workflowEdge: workflowEdgeEntityOverrides,
    workflowNode: workflowNodeEntityOverrides,
    workflowNodeData: workflowNodeDataEntityOverrides,
