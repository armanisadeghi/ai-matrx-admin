...
import {
  FieldOverrideName,
  AllEntityFieldOverrides,
  ProcessedField,
  EntityProcessedFields,
} from "./overrideTypes";
...
export function processValidationFunctions(
  entityName: EntityKeys,
  fieldName: string,
  originalValue: any[],
  fieldOverrides: AllEntityFieldOverrides,
...
export function processForeignKeyReference(
  entityName: EntityKeys,
  fieldName: string,
  originalValue: any,
  fieldOverrides: AllEntityFieldOverrides,
...
export function processFieldNameFormats(
  entityName: EntityKeys,
  fieldName: string,
  originalValue: any,
  fieldOverrides: AllEntityFieldOverrides,
...
export function processField<TEntity extends EntityKeys>(
  ...
  const baseProcessedField: Partial<ProcessedField> = {
    ...
    uniqueColumnId: processFieldProperty(
      entityName,
      fieldName,
      "uniqueColumnId",
      originalField.uniqueColumnId,
      fieldOverrides,
    ),
    uniqueFieldId: processFieldProperty(
      entityName,
      fieldName,
      "uniqueFieldId",
      originalField.uniqueFieldId,
      fieldOverrides,
    ),
    dataType: processFieldProperty(
      entityName,
      fieldName,
      "dataType",
    ...
    isRequired: processFieldProperty(
      entityName,
      fieldName,
      "isRequired",
    ...
    maxLength: processFieldProperty(
      entityName,
      fieldName,
      "maxLength",
    ...
    isArray: processFieldProperty(
      entityName,
      fieldName,
      "isArray",
      originalField.isArray,
      fieldOverrides,
    ),
    defaultValue: processFieldProperty(
      entityName,
      fieldName,
      "defaultValue",
    ...
    isPrimaryKey: processFieldProperty(
      entityName,
      fieldName,
      "isPrimaryKey",
      originalField.isPrimaryKey,
      fieldOverrides,
    ),
    isDisplayField: processFieldProperty(
      entityName,
      fieldName,
      "isDisplayField",
      originalField.isDisplayField,
      fieldOverrides,
    ),

    // Specialized processors
    defaultGeneratorFunction: processDefaultGeneratorFunction(
      entityName,
      fieldName,
      originalField.defaultGeneratorFunction,
      fieldOverrides,
    ),
    validationFunctions: processValidationFunctions(
      entityName,
      fieldName,
      originalField.validationFunctions,
      fieldOverrides,
    ),
    componentProps: processComponentProps(
      entityName,
      fieldName,
      originalField.componentProps,
      fieldOverrides,
    ),
    foreignKeyReference: processForeignKeyReference(
      entityName,
      fieldName,
      originalField.foreignKeyReference,
      fieldOverrides,
    ),
    ...
    fieldNameFormats: processFieldNameFormats(
      entityName,
      fieldName,
      originalField.fieldNameFormats,
      fieldOverrides,
    ),

    // Remaining basic properties
    exclusionRules: processFieldProperty(
      entityName,
      fieldName,
      "exclusionRules",
      originalField.exclusionRules,
      fieldOverrides,
    ),
    defaultComponent: processFieldProperty(
      entityName,
      fieldName,
      "defaultComponent",
      originalField.defaultComponent,
      fieldOverrides,
    ),
    structure: processFieldProperty(
      entityName,
      fieldName,
      "structure",
      originalField.structure,
      fieldOverrides,
    ),
    isNative: processFieldProperty(
      entityName,
      fieldName,
      "isNative",
      originalField.isNative,
      fieldOverrides,
    ),
    typeReference: processFieldProperty(
      entityName,
      fieldName,
      "typeReference",
      originalField.typeReference,
      fieldOverrides,
    ),
    enumValues: processFieldProperty(
      entityName,
      fieldName,
      "enumValues",
      originalField.enumValues,
      fieldOverrides,
    ),
    entityName: processFieldProperty(
      entityName,
      fieldName,
      "entityName",
      originalField.entityName,
      fieldOverrides,
    ),
    databaseTable: processFieldProperty(
      entityName,
      fieldName,
      "databaseTable",
      originalField.databaseTable,
      fieldOverrides,
    ),
  };
