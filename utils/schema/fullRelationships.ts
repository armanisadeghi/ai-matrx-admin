...
export const entityRelationships = {
        ...
        relationshipDetails: {
            ...
            foreignKeys: {
                conversation: {
                    ...
                    foreignEntity: "conversation",
                    column: "conversation_id",
                    fieldName: "conversationId",
                    foreignField: "id",
                    foreignColumn: "id",
                    relationshipType: "many-to-many",
                    constraintName: "message_conversation_id_fkey",
                },
            },
            referencedBy: {},
        },
    ...
    recipeMessageReorderQueue: {
        ...
        relationshipDetails: {
            ...
            tableName: "recipe_message_reorder_queue",
            foreignKeys: {},
            referencedBy: {},
        },
    },
        ...
        relationshipDetails: {
            ...
            foreignKeys: {
                organizations: {
                    ...
                    foreignEntity: "organizations",
                    column: "granted_to_organization_id",
                    fieldName: "grantedToOrganizationId",
                    foreignField: "id",
                    foreignColumn: "id",
                    relationshipType: "many-to-many",
                    constraintName: "org_reference",
                },
            },
            referencedBy: {},
        },
    ...
    organizations: {
        ...
        oneToMany: [],
        undefined: [],
        inverseReferences: ["permissions", "organizationMembers", "organizationInvitations"],
        relationshipDetails: {
            ...
            referencedBy: {
                permissions: {
                    ...
                    foreignEntity: "permissions",
                    field: "grantedToOrganizationId",
                    column: "granted_to_organization_id",
                    foreignField: "id",
                    foreignColumn: "id",
                    constraintName: "org_reference",
                ...
                organizationMembers: {
                    ...
                    foreignEntity: "organizationMembers",
                ...
                organizationInvitations: {
                    foreignTable: "organization_invitations",
                    foreignEntity: "organizationInvitations",
                    field: "organizationId",
                    column: "organization_id",
                    foreignField: "id",
                    foreignColumn: "id",
                    constraintName: "organization_invitations_organization_id_fkey",
                },
            },
        },
    },
