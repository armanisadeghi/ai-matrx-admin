...
export const entityRelationships = {
    ...
    recipe: {
        ...
        oneToMany: [],
        undefined: [],
        inverseReferences: ['recipeDisplay', 'recipeProcessor', 'recipeModel', 'recipeBroker', 'recipeTool', 'recipeFunction', 'recipeMessage'],
        relationshipDetails: {
            entityName: 'recipe',
            tableName: 'recipe',
            foreignKeys: {},
