...
export const entityFieldNameGroups: EntityFieldNameGroupsType = {
  ...
  compiledRecipe: {
  nativeFields: ["id", "recipeId", "version", "compiledRecipe", "createdAt", "updatedAt"],
  primaryKeyFields: ["id"],
  nativeFieldsNoPk: ["recipeId", "version", "compiledRecipe", "createdAt", "updatedAt"]
},
  dataBroker: {
  ...
  dataInputComponent: {
  nativeFields: ["id", "options", "includeOther", "min", "max", "step", "minRows", "maxRows", "acceptableFiletypes", "src", "classes", "colorOverrides", "additionalParams", "subComponent", "component", "name"],
  primaryKeyFields: ["id"],
  nativeFieldsNoPk: ["options", "includeOther", "min", "max", "step", "minRows", "maxRows", "acceptableFiletypes", "src", "classes", "colorOverrides", "additionalParams", "subComponent", "component", "name"]
},
  dataOutputComponent: {
