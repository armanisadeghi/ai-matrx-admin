...
export const useRelationshipCreate = (
    ...
    const relatedData = useMemo(
        () => new RelatedDataManager(joinEntityName, { joiningEntity: true, child: true }),
        [joinEntityName]
    );
...
export const useCoordinatedCreate = <T extends Record<string, any>>({ 
    joiningEntityKey, 
    childEntityKey, 
    onSuccess, 
    onError 
}: UseCoordinatedCreateOptions) => {
...
export const useDirectCreateRecord = <T extends Record<string, any>>({ 
    entityKey, 
    onSuccess, 
    onError 
