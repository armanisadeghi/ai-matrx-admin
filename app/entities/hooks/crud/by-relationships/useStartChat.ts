...
interface UseStartChatReturn {
    ...
    saveConversationAndMessage: () => Promise<StartChatResult>;
}
...
export const useStartChat = ({
...
}: UseStartChatParams): UseStartChatReturn => {
    ...
    const saveConversationAndMessage = useCallback(async (): Promise<StartChatResult> => {
        try {
