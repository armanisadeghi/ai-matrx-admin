...
import EntityInput from "@/components/matrx/ArmaniForm/field-components/EntityInput";
...
const RelationalInput: React.FC<RelationalInputProps> = ({
  ...
  return (
    <div className="relative flex gap-2">
      <EntityInput value={value} onChange={onChange} {...props} />
      {relational && (
        <RelationalButton
          config={relational}
          currentValue={value}
...
export type {
  RelationalConfig,
  RelationalInputProps,
  RelationalButtonBaseProps,
};
