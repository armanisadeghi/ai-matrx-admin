...
interface EntityNumberInputProps extends EntityComponentBaseProps,
...
const NUMBER_TYPE_CONFIGS: Record<NumberType, NumberTypeConfig> = {
    ...
    real: { min: -3.4E+38, max: 3.4E+38, step: 0.000001, decimals: 6 },
    double: { min: -1.7E+308, max: 1.7E+308, step: 0.000001, decimals: 15 },
