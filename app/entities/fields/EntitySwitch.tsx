...
interface EntitySwitchProps extends EntityComponentBaseProps,
    Omit<React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root>, 'onChange' | 'size' | 'value'> {
    value: boolean;
    labelPosition?: 'default' | 'inline' | 'above' | 'left' | 'right';
}
...
>(({
        ...
        >
            <SwitchPrimitives.Thumb
                className={cn(
                    ...
                    thumbSizes[size as keyof typeof thumbSizes] || thumbSizes.default
                )}
            />
        </SwitchPrimitives.Root>
    );
    ...
    const renderLabel = dynamicFieldInfo.displayName && (
        <Label
            ...
            htmlFor={uniqueId}
            className={cn(
                densityConfig[density as keyof typeof densityConfig]?.label || densityConfig.normal.label,
    ...
    return (
        <div
            ...
            className={cn(
                ...
                densityConfig[density as keyof typeof densityConfig]?.wrapper || densityConfig.normal.wrapper,
                "w-full"
            )}
        >
            {renderLabel}
