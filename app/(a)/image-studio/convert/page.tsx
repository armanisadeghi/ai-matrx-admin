 ...
 * dynamically imported with ssr:false so there's no server/client mismatch
 * around FileReader/URL.createObjectURL/react-dropzone.
 */
    ...
    return (
        <div className="h-[calc(100dvh-2.5rem)] flex flex-col overflow-hidden bg-background">
            ...
            <div className="flex-1 min-h-0">
                <ImageStudioShell defaultFolder="image-studio" />
            </div>
        </div>
    );
}
