/**
 * app/(a)/image-manager/loading.tsx
 *
 * Zero-CLS skeleton — matches the rendered shell exactly: 176px sidebar
 * with 6 nav rows, header bar in the main pane, and a thumbnail grid
 * placeholder.
 */

import { Skeleton } from "@/components/ui/skeleton";

export default function ImageManagerLoading() {
  return (
