      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl">
            ...
            You can build &quot;Sign in with AI Matrx&quot; experiences,
            authenticate AI agents via MCP, or integrate with your platform
            using standards-compliant OAuth.
          </p>
        </header>
        ...
        <section className="mb-14">
          <SectionHeading id="integration-modes">
            Two Integration Modes
          </SectionHeading>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            AI Matrx supports both pre-registered and dynamically registered
            OAuth clients.
          </p>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="rounded-xl border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                For web apps, mobile apps, and services where you know the
                client in advance. You receive a{" "}
            ...
            <div className="rounded-xl border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                For MCP clients, AI agents, and tools that register themselves
        ...
        <section className="mb-14">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            parameter of your authorization request. Default scope when none is
            provided:{" "}
            <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-neutral-700 text-xs font-mono">
              email
            </code>
        ...
        <section className="mb-14">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            ...
            PKCE. Here is the complete step-by-step process.
          </p>
          ...
          <div className="space-y-6">
            ...
            <FlowStep number={1} title="Generate PKCE Parameters">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Before initiating the flow, generate a random{" "}
                <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-neutral-700 text-xs font-mono">
                  code_verifier
                </code>{" "}
                and derive a{" "}
...
const codeChallenge = await generateCodeChallenge(codeVerifier);`}
            ...
            <FlowStep number={2} title="Redirect to Authorization Endpoint">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Redirect the user to the AI Matrx authorization endpoint with
  ...
  &scope=openid email profile`}
              ...
              <div className="mt-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200/70 dark:border-amber-700/40 px-3.5 py-2.5">
                <p className="text-xs text-amber-700 dark:text-amber-300">
                  <strong>Required parameters:</strong> response_type,
                  client_id, redirect_uri, code_challenge,
                  code_challenge_method. Always include{" "}
                  <code className="font-mono">state</code> for CSRF protection.
                </p>
              </div>
            </FlowStep>
            ...
            <FlowStep number={3} title="User Authenticates and Consents">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                AI Matrx shows a login screen (if needed) and then a consent
                screen where the user approves or denies access. The user sees
                your app name, requested scopes, and the redirect domain.
              </p>
            </FlowStep>
            ...
            <FlowStep number={4} title="Handle the Callback">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                After consent, the user is redirected back to your{" "}
                <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-neutral-700 text-xs font-mono">
                  redirect_uri
                </code>{" "}
...
// tokens: { access_token, token_type, expires_in, refresh_token, scope, id_token? }`}
            ...
            <FlowStep number={6} title="Use the Access Token">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Use the access token to call the AI Matrx API on behalf of the
                user.
              </p>
              <CodeBlock
                language="javascript"
...
// Use the access token with your own API
const apiResponse = await fetch('https://www.aimatrx.com/api/your-endpoint', {
  headers: { Authorization: 'Bearer ' + tokens.access_token },
}).then(r => r.json());`}
              />
            </FlowStep>
        ...
        <section className="mb-14">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Access tokens expire after 1 hour. Use the refresh token to obtain a
            new access token without re-prompting the user.
          </p>
          <CodeBlock
            language="javascript"
            code={`const refreshResponse = await fetch('${BASE_URL}/api/oauth/token', {
  method: 'POST',
  headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
  body: new URLSearchParams({
...
async function verifyAccessToken(token) {
  const { payload } = await jwtVerify(token, JWKS, {
    // The issuer claim is set by AI Matrx at token signing time
    issuer: 'https://auth.aimatrx.com/v1',
  ...
  return payload; // includes sub, email, client_id, etc.
        ...
        <section className="mb-14">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            automatically using the dynamic client registration endpoint. No
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 p-4">
              ...
              <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-1.5 list-decimal list-inside">
                ...
                <li>
                  Client receives tokens and can access data on behalf of the
                  user
                </li>
              </ol>
            </div>
...
const regResponse = await fetch('${BASE_URL}/api/oauth/clients/register', {
  method: 'POST',
        ...
        <section className="mb-8">
          <div className="rounded-xl border border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800 p-6 text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              To register a pre-configured OAuth app or get integration support,
              reach out to the AI Matrx team.
            </p>
            <a
              href="/contact"
