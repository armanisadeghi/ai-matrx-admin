...
const PRESETS: Array<{ preset: ImagePreset; label: string; description: string }> = [
    { preset: 'social',  label: 'Social',  description: '1400² cover + 1200×630 OG + 400² thumb (podcasts, posts, articles)' },
    { preset: 'cover',   label: 'Cover',   description: '1200×630 only (link previews, OG-only)' },
    { preset: 'avatar',  label: 'Avatar',  description: '400 / 128 / 48 (profile photos, user icons)' },
    { preset: 'logo',    label: 'Logo',    description: '512 / 200 / 64 (org logos, app icons)' },
    { preset: 'favicon', label: 'Favicon', description: '192 / 64 (browser tab icons, small marks)' },
    { preset: 'square',  label: 'Square',  description: '1024² single square (gallery items, thumbnails)' },
];

export default function ImageAssetUploaderDisplay({ component }: ComponentDisplayProps) {
...
// - Uploads under the user's folder with RLS protection`;
    ...
    const handleOpenWindow = () => {
        openWindow({
            ...
            description: 'This opens as a floating, draggable window — try it anywhere in the app.',
        ...
        >
            <div className="w-full max-w-2xl space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <Button type="button" variant="outline" size="sm" onClick={handleOpenWindow}>
