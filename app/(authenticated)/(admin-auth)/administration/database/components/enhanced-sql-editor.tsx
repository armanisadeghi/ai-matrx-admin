...
export const EnhancedSQLEditor = ({ 
  ...
  return (
    <Card className="w-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm">
