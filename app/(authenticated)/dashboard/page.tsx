...
const DashboardPage = () => {
  ...
  const quickAccess = [
    { id: 1, name: "Text Summarizer", description: "Condense long documents", icon: <MessageSquare size={20} className="text-purple-500 dark:text-purple-400" /> },
    { id: 2, name: "Image Generator", description: "Create custom visuals", icon: <Image size={20} className="text-green-500 dark:text-green-400" /> },
    { id: 3, name: "Data Analyzer", description: "Extract insights", icon: <BarChart3 size={20} className="text-blue-500 dark:text-blue-400" /> },
  ];
  ...
  return (
    <>
      ...
      <div 
        className="min-h-screen w-full bg-zinc-100 dark:bg-zinc-900 text-gray-800 dark:text-gray-100"
                ...
                <Link href="/chat" className="block">
                  <div className="rounded-xl p-5 cursor-pointer transform transition hover:scale-105 bg-white dark:bg-zinc-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 shadow-md dark:shadow-zinc-800/20">
                    <div className="flex flex-col items-center text-center space-y-3">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Interact with our reimagined AI chat interface</p>
                    </div>
                  </div>
                </Link>
                ...
                <Link href="/applets" className="block">
                  <div className="rounded-xl p-5 cursor-pointer transform transition hover:scale-105 bg-white dark:bg-zinc-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 shadow-md dark:shadow-zinc-800/20">
                    <div className="flex flex-col items-center text-center space-y-3">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Access various AI-integrated applications</p>
                    </div>
                  </div>
                </Link>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-baseline">
                          ...
                          <span className={`text-xs ${stat.change.startsWith('+') ? 'text-green-500 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
                            {stat.change}
                          </span>
                        </div>
                      </div>
