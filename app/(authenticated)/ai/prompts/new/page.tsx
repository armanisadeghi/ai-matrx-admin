    ...
    return (
        <>
            {parts.map((part, idx) => {
                if (part.match(/\{\{[^}]+\}\}/)) {
                    return (
                        <span key={idx} className="text-green-500 dark:text-green-400 font-medium">
                            {part}
                        </span>
                    );
                }
        ...
        <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-1/2 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex flex-col">
                    <div className="flex-1 overflow-y-auto pl-2 pr-1 space-y-2" style={{ scrollbarGutter: "stable" }}>
                        {/* Model Configuration */}
                        <div className="space-y-3">
                            <div className="flex items-center justify-between pt-2">
                                <div className="flex items-center gap-3">
                                    <Label className="text-xs font-semibold text-gray-800 dark:text-gray-200">Model</Label>
                                    <Select value={model} onValueChange={setModel}>
                                        <SelectTrigger className="h-8 bg-transparent border-none hover:bg-gray-200 dark:hover:bg-gray-700 w-auto min-w-[180px] text-xs focus-none">
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            <Label className="text-xs font-semibold text-gray-800 dark:text-gray-200">Variables</Label>
                            {variables.map((variable) => (
                                <span
                                    key={variable}
                                    className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md text-xs font-medium border border-gray-200 dark:border-gray-700"
                                >
                                    {variable}
                                    <X
                            ...
                            <Popover open={isAddingVariable} onOpenChange={setIsAddingVariable}>
                                ...
                                <PopoverContent className="w-64 p-3" align="start">
                                    <div className="space-y-2">
                                        <Label className="text-xs font-medium text-gray-700 dark:text-gray-300">Variable name</Label>
                                        <input
                                            type="text"
                        ...
                        {/* Tools */}
                        <div className="flex items-center gap-2 flex-wrap">
                            <Label className="text-xs font-semibold text-gray-800 dark:text-gray-200">Tools</Label>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <Label className="text-xs font-semibold text-gray-800 dark:text-gray-200">System</Label>
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-7 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                        ...
                        {/* Prompt Messages */}
                        <div className="space-y-3">
                            <Label className="text-xs font-semibold text-gray-800 dark:text-gray-200">Prompt messages</Label>
                            <div className="space-y-3">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-between px-4 py-2 border-b border-gray-300 dark:border-gray-700">
                                                ...
                                                >
                                                    <SelectTrigger className="h-7 w-28 text-xs bg-transparent border-none shadow-none focus:ring-0 px-0 capitalize">
                                                        <SelectValue />
                                                    </SelectTrigger>
                                                    <SelectContent>
