...
export default function ContainersListPage() {
    ...
    const searchInput = (
        <div className="relative w-64">
            ...
            <Input placeholder="Search containers..." className="pl-8" value={searchTerm} onChange={handleSearchChange} />
        </div>
    );
        ...
        >
            {isLoading ? (
                ...
                <div className="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <Button onClick={() => router.push("/apps/app-builder/containers/create")}>Create First Container</Button>
                </div>
            ) : (
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="w-[200px]">Short Label</TableHead>
                                    ...
                                    <TableCell className="font-medium">
                                        <div className="flex items-center">
                                            ...
                                            {container.label ? (
                                                ...
                                                <span className="text-gray-500 dark:text-gray-400">No name</span>
                                            )}
                                        </div>
                                    </TableCell>
