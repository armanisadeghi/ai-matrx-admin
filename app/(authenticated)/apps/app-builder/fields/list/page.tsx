...
export default function FieldsListPage() {
  ...
  const renderIcon = (field: FieldBuilder) => {
    ...
    return componentIconMap[field.component] || 
      <TextCursorInput className="h-5 w-5 text-gray-500 dark:text-gray-400" />;
  };
      ...
      {isLoading ? (
        ...
        <div className="py-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4 max-w-md">
            You haven't created any field components yet. Field components are reusable form elements that can be used in your applets.
          </p>
          <Button onClick={() => router.push('/apps/app-builder/fields/create')}>
            Create First Field
          </Button>
        </div>
      ) : (
