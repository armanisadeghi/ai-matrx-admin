...
export default function AdditionalInfoTab({ appId }: AdditionalInfoTabProps) {
  ...
  return (
    <div className="space-y-6">
      <Card className="p-6">
        <h3 className="text-lg font-medium mb-4 text-gray-800 dark:text-gray-200">Additional Information</h3>
