...
const wrongFieldKey = 'not_valid_but_should_see'; // Replace with a valid field key
...
const queryOptions = {
    filters: {[fieldKey]: modulePathValue},
    sorts: [{className: classNameValue, ascending: true}],
    columns: ["returnBroker", "not_areal_field", wrongFieldKey],
    limit: 10,
    offset: 0,
};
...
const SelectorTestPage: React.FC = () => {
    ...
    // Schema Selectors
    const entitySchema = useAppSelector((state) => schemaSelectors.selectEntitySchema(state, entityKey));
    ...
    const selectorData = [
        // Direct State Access Selectors
        { category: "Direct State Access", name: "selectSchema", props: "None", result: JSON.stringify(schema, null, 2) },
        { category: "Direct State Access", name: "selectEntityNames", props: "None", result: JSON.stringify(entityNames, null, 2) },
        { category: "Direct State Access", name: "selectEntities", props: "None", result: JSON.stringify(entities, null, 2) },
        { category: "Direct State Access", name: "selectFields", props: "None", result: JSON.stringify(fields, null, 2) },
        { category: "Direct State Access", name: "selectFieldsByEntity", props: "None", result: JSON.stringify(fieldsByEntity, null, 2) },
        { category: "Direct State Access", name: "selectIsInitialized", props: "None", result: JSON.stringify(isInitialized, null, 2) },  // not getting a response

        // Direct Conversion Map Selectors
        { category: "Conversion Maps", name: "selectEntityNameToCanonical", props: "None", result: JSON.stringify(entityNameToCanonical, null, 2) },
        { category: "Conversion Maps", name: "selectFieldNameToCanonical", props: "None", result: JSON.stringify(fieldNameToCanonical, null, 2) },
        { category: "Conversion Maps", name: "selectEntityNameFormats", props: "None", result: JSON.stringify(entityNameFormats, null, 2) },
        { category: "Conversion Maps", name: "selectFieldNameFormats", props: "None", result: JSON.stringify(fieldNameFormats, null, 2) },
        { category: "Conversion Maps", name: "selectEntityNameToDatabase", props: "None", result: JSON.stringify(entityNameToDatabase, null, 2) },
        { category: "Conversion Maps", name: "selectEntityNameToBackend", props: "None", result: JSON.stringify(entityNameToBackend, null, 2) },
        { category: "Conversion Maps", name: "selectFieldNameToDatabase", props: "None", result: JSON.stringify(fieldNameToDatabase, null, 2) },
        { category: "Conversion Maps", name: "selectFieldNameToBackend", props: "None", result: JSON.stringify(fieldNameToBackend, null, 2) },
        ...
        { category: "Core Derived Selectors", name: "selectField", props: JSON.stringify({ entityName: entityKey, fieldName: fieldKey }, null, 2), result: JSON.stringify(field, null, 2) },
        { category: "Core Derived Selectors", name: "selectEntityPrimaryKeyField", props: JSON.stringify({ entityName: entityKey }, null, 2), result: JSON.stringify(entityPrimaryKeyField, null, 2) },
        { category: "Core Derived Selectors", name: "selectEntityDisplayField", props: JSON.stringify({ entityName: entityKey }, null, 2), result: JSON.stringify(entityDisplayField, null, 2) },
        { category: "Core Derived Selectors", name: "selectEntityRelationships", props: JSON.stringify({ entityName: entityKey }, null, 2), result: JSON.stringify(entityRelationships, null, 2) },
        { category: "Core Derived Selectors", name: "selectRelatedEntities", props: JSON.stringify({ entityName: entityKey }, null, 2), result: JSON.stringify(relatedEntities, null, 2) },
        ...
        { category: "Entity Name Conversion", name: "selectEntityAnyName", props: JSON.stringify({ entityName: entityKey, format: "pretty" }, null, 2), result: JSON.stringify(entityAnyName, null, 2) },
        ...
        { category: "Field Name Conversion", name: "selectFieldAnyName", props: JSON.stringify({ entityName: entityKey, fieldName: fieldKey, format: "pretty" }, null, 2), result: JSON.stringify(fieldAnyName, null, 2) },
        ...
        { category: "Conversion", name: "selectFormatConversion", props: JSON.stringify({ entityName: entityKey, data: sampleData, format: "pretty" }, null, 2), result: JSON.stringify(formatConversion, null, 2) },
        { category: "Conversion", name: "selectUnknownFormatConversion", props: JSON.stringify({ entityNameOrAlias: entityKey, data: sampleData, targetFormat: "pretty" }, null, 2), result: JSON.stringify(unknownFormatConversion, null, 2) },
        { category: "Conversion", name: "selectUnknownFieldFormatConversion", props: JSON.stringify({ entityNameOrAlias: entityKey, fieldNameOrAlias: fieldKey, targetFormat: "pretty" }, null, 2), result: JSON.stringify(unknownFieldFormatConversion, null, 2) },
        { category: "Conversion", name: "selectFrontendConversion", props: JSON.stringify({ entityName: entityKey, data: sampleData }, null, 2), result: JSON.stringify(frontendConversion, null, 2) },
        { category: "Conversion", name: "selectCanonicalConversion", props: JSON.stringify({ entityName: entityKey, data: sampleData }, null, 2), result: JSON.stringify(canonicalConversion, null, 2) },
        ...
        },
        {
            ...
            props: JSON.stringify({ entityName: entityKey, columns: [fieldKey, fieldKey2] }, null, 2),
                        ...
                        <TableBody>
                            {selectorData.map((item, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        <pre className="text-xs overflow-auto max-h-40">{item.result}</pre>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
