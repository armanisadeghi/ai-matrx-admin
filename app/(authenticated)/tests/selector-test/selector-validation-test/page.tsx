...
const SelectorTestPage: React.FC = () => {
    ...
    const payloadObjectKeyReplacement = useAppSelector((state) =>
        schemaSelectors.selectReplaceKeysInObject(state, dataObject, sampleKeyMapping)
    );

    const expandedPayloadOptionsDatabaseConversion = useAppSelector((state) =>
        schemaSelectors.selectUnifiedQueryDatabaseConversion(state, {
            entityName: entityKey,
            options: unifiedQuery
        })
    );
    ...
    const selectorData = [
        ...
        //
        {category: "Conversion Maps", name: "selectEntityNameToDatabase", props: "None", result: entityNameToDatabase},
        {category: "Conversion Maps", name: "selectFieldNameToDatabase", props: entityKey, result: fieldMapping},
        {category: "Conversion Maps", name: "selectFieldNameToDatabase", props: "None", result: fieldNameToDatabase},
        ...
        // Core Derived Selectors
        {
            ...
            name: "selectEntity",
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entity, null, 2)
        },
        {
            category: "Core Derived Selectors",
            name: "selectEntityFields",
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entityFields, null, 2)
        },
        {
            category: "Core Derived Selectors",
            name: "selectField",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: field
        },
        {
            category: "Core Derived Selectors",
            ...
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: entityPrimaryKeyField
        },
        {
            category: "Core Derived Selectors",
            name: "selectEntityDisplayField",
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: entityDisplayField
        },
        {
            category: "Core Derived Selectors",
        ...
        // Entity Name Conversion Selectors
        {
            ...
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entityDatabaseName, null, 2)
        },

        {
            ...
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entityBackendName, null, 2)
        },
        {
            category: "Entity Name Conversion",
            name: "selectEntityFrontendName",
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entityFrontendName, null, 2)
        },
        {
            category: "Entity Name Conversion",
            name: "selectEntityPrettyName",
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entityPrettyName, null, 2)
        },
        {
            category: "Entity Name Conversion",
            name: "selectEntityAnyName",
            props: JSON.stringify({entityName: entityKey, format: formatTwo}, null, 2),
            result: JSON.stringify(entityAnyName, null, 2)
        },
...

        {
            ...
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: JSON.stringify(fieldDatabaseName, null, 2)
        },
        {
            category: "Field Name Conversion",
            name: "selectFieldBackendName",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: JSON.stringify(fieldBackendName, null, 2)
        },
        {
            category: "Field Name Conversion",
            name: "selectFieldFrontendName",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: JSON.stringify(fieldFrontendName, null, 2)
        },
        {
            category: "Field Name Conversion",
            name: "selectFieldPrettyName",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: JSON.stringify(fieldPrettyName, null, 2)
        },
        {
            category: "Field Name Conversion",
            name: "selectFieldAnyName",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey, format: formatThree}, null, 2),
            result: JSON.stringify(fieldAnyName, null, 2)
        },
...

        {
            ...
            props: JSON.stringify({entityName: entityKey}, null, 2),
            result: JSON.stringify(entitySchema, null, 2)
        },
        {
            category: "Schema Selectors",
            name: "selectFieldSchema",
            props: JSON.stringify({entityName: entityKey, fieldName: fieldKey}, null, 2),
            result: JSON.stringify(fieldSchema, null, 2)
        },
...

        {
            ...
            props: JSON.stringify({entityName: entityKey, data: sampleData}, null, 2),
            result: JSON.stringify(databaseConversion, null, 2)
        },
        {
            category: "Conversion",
            name: "selectBackendConversion",
            props: JSON.stringify({entityName: entityKey, data: sampleData}, null, 2),
            result: JSON.stringify(backendConversion, null, 2)
        },
...

        {
            ...
            props: JSON.stringify({entityName: entityKey, data: sampleData}, null, 2),
            result: JSON.stringify(prettyConversion, null, 2)
        },


        {
            category: "Conversion",
            name: "selectFormatConversion",
            props: JSON.stringify({entityName: entityKey, data: sampleData, format: formatOne}, null, 2),
            result: JSON.stringify(AnyObjectFormatConversion, null, 2)
        },

        {
            category: "Conversion",
            name: "selectUnknownFormatConversion",
            props: JSON.stringify({entityAlias: entityAlias, data: sampleData, targetFormat: formatThree}, null, 2),
            result: UnknownToAnyObjectFormatConversion
        },

        {
            category: "Conversion",
            name: "selectFrontendConversion",
            props: JSON.stringify({entityName: entityKey, data: sampleDataTwo}, null, 2),
            result: JSON.stringify(frontendConversion, null, 2)
        },
...

        {
            ...
            props: JSON.stringify({entityName: entityKey, options: unifiedQuery}, null, 2),
            result: expandedPayloadOptionsDatabaseConversion
        },

        {
            category: "Key Replacement",
            name: "selectReplaceKeysInObject",
            props: JSON.stringify({data: dataObject, keyMapping: sampleKeyMapping}, null, 2),
            result: payloadObjectKeyReplacement
        },


        //payloadObjectKeyReplacement dataObject, sampleKeyMapping
