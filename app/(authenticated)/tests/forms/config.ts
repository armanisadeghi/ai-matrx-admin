...
export const pages: ModulePage[] = [

    {
        ...
        relative: true,
        description: 'Attempt to use the Full Container which extracts away the complexities, but might not give the full power later for doing other things. We will see.'
    },
    {
