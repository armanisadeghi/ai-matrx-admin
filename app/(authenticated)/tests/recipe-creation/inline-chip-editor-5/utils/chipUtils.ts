...
import { CHIP_VARIANTS } from "../components/Chip";
  ...
  export const isNodeWithinEditor = (node: Node, editorElement: HTMLElement): boolean => {
 ...
 */
export function findOrCreateLineDiv(startContainer: Node, editorRef: HTMLElement): HTMLElement {
 ...
 */
export function createChipContainer(chipId: string, chipContent: string): HTMLSpanElement {
...
/**
 * Extracts selection information from the editor
 */
// export function getSelectionInfo(editorRef: HTMLElement): {
//   selection: Selection;
//   range: Range;
//   selectedText: string;
// } | null {
...
/**
 * Validates if a selection is within a single text node
 */
 ...
 */
export function getParentLineDiv(node: Node, editorRef: HTMLElement): HTMLElement | null {
