...
//     const [editorData, setEditorData] = useState<string>(JSON.stringify(currentData, null, 2));
//     const [isInvalidJson, setIsInvalidJson] = useState<boolean>(false);
//
//     const handleDataChange = (newData: object) => {
//         setCurrentData(newData as JsonDataType);
//         setEditorData(JSON.stringify(newData, null, 2));
//     };
//
