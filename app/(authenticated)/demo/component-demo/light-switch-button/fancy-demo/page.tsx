  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        Demo of the LightSwitchToggle Component
      </h1>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("width", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                        ...
                        <SelectContent>
                          <SelectItem value="w-12">12</SelectItem>
                          <SelectItem value="w-16">16</SelectItem>
                          <SelectItem value="w-18">18</SelectItem>
                          <SelectItem value="w-20">20</SelectItem>
                          <SelectItem value="w-24">24</SelectItem>
                          <SelectItem value="w-28">28</SelectItem>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("height", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                        ...
                        <SelectContent>
                          <SelectItem value="h-6">6</SelectItem>
                          <SelectItem value="h-7">7</SelectItem>
                          <SelectItem value="h-8">8</SelectItem>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAdvancedChange("labels", {
                            ...advancedSwitchProps.labels,
                            on: e.target.value,
                          })
                        }
