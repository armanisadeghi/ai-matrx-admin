            ...
            <div className="max-w-2xl mx-auto p-6 space-y-6">
                ...
                <div className="rounded-lg border border-border bg-card p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="text-sm font-medium block mb-1.5">Favicon URL</label>
                            <Input
                                value={favicon}
                ...
                <div className="rounded-lg border border-border bg-card p-5 space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                        CSS applied to all pages. Use this for base styles, typography, and layout.
                    </p>
                    <Textarea
                        value={globalCss}
                ...
                <div className="rounded-lg border border-border bg-card p-5 space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Theme configuration, navigation structure, and footer will be editable here in a future update.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="rounded-md border border-border/50 bg-muted/20 p-3">
                            <p className="text-xs font-medium text-muted-foreground">Theme Config</p>
