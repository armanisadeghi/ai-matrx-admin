...
import {adminCategories} from "@/app/(legacy)/legacy/admin/constants/categories";
import {useRouter} from "next/navigation";
import ErrorBoundary from '@/app/(legacy)/legacy/admin/components/entities/ErrorBoundary';
