...
export const EntityControlSetStacked: React.FC<EntityControlSetProps> = ({
    unifiedProps,
    setUnifiedProps,
    additionalSettings = {},
    ...
    return (
        <div className="flex-1 p-1">
            <div className="flex flex-col">
                {/* ROW 1: PRIMARY LAYOUT & COMPONENT SELECTION */}
                ...
                {/* ROW 2: RESIZABLE LAYOUT OPTIONS (when applicable) */}
                ...
                {/* ROW 5: INLINE ENTITIES & ADVANCED SETTINGS */}
...
export default EntityControlSetStacked;