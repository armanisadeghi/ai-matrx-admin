...
import {layoutConfigs} from "@/app/(legacy)/legacy/tests/dynamic-layouts/layoutConfigs";
import {ContentLayout} from "@/app/(legacy)/legacy/tests/dynamic-layouts/basic-layout-options/LayoutOptions";
