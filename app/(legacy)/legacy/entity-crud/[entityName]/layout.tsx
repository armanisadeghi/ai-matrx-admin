// app/(authenticated)/entity-crud/[entityName]/layout.tsx
// No metadata export — breadcrumb shell only; metadata set by parent entity-crud/layout.tsx.
...
async function EntityBreadcrumbs({
  ...
  const displayEntityName = entityName
    ? formatName(entityPrettyName || entityName)
    : null;
  const displayFieldName = primaryKeyField
    ? formatName(fieldPrettyName || primaryKeyField)
    : null;
