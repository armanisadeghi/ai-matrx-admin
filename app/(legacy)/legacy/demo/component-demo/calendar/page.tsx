...
import { MatrxCalendar } from "@/components/ui/samples/calendar";
import {
  Select,
  SelectTrigger,
  SelectValue,
...
export default function DemoPage() {
  ...
  const [advancedDate, setAdvancedDate] = useState<Date | Date[] | undefined>(
    undefined,
  );
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        Demo of the MatrxCalendar Component
      </h1>
      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="advanced">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        ) => handleCalendarPropChange("mode", value)}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(
                          value: "none" | "basic" | "moderate" | "enhanced",
                        ) => handleCalendarPropChange("animationLevel", value)}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
          ...
          <Card className="mt-4">
            ...
            <CardContent>
              <pre>
                {JSON.stringify({ advancedDate, ...calendarProps }, null, 2)}
              </pre>
            </CardContent>
          </Card>
        </TabsContent>
