  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        Demo of the MatrxJsonViewer Component
      </h1>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleJsonViewerChange(
                            "density",
                            value as ComponentDensity,
                          )
                        }
                      >
                        <SelectTrigger>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <Checkbox
                        ...
                        onCheckedChange={(v) =>
                          handleJsonViewerChange("initialExpanded", v === true)
                        }
                        className="shrink-0"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <Checkbox
                        ...
                        onCheckedChange={(v) =>
                          handleJsonViewerChange("hideControls", v === true)
                        }
                        className="shrink-0"
                      />
