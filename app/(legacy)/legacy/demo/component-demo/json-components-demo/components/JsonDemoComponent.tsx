            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                        <Switch id="expand-switch" checked={isExpanded} onCheckedChange={setIsExpanded} />
                        <Label htmlFor="expand-switch">Expand All</Label>
                    </div>
                    <div className="flex items-center space-x-2 mb-4">
                        <Switch id="mode-switch" checked={isStringMode} onCheckedChange={toggleDataMode} />
                    ...
                    <Card>
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <FullJsonViewer data={currentData} initialExpanded={isExpanded} title="Custom Title for Full JSON Viewer" />
                                <TextDivider text={"END"} />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <JsonEditor data={editorData} onChange={handleDataChange} initialExpanded={isExpanded} />
                                <TextDivider text={"END"} />
                            </div>
                            <div>
                                <h3 className="text-lg font-semibold mb-2">JsonEditor with Formatting</h3>
                                <div className="flex items-center space-x-2 mb-2">
                                    <Switch id="format-switch" checked={showFormatting} onCheckedChange={setShowFormatting} />
