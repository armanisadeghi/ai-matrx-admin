...
import {
  MatrxRadioGroup,
  MatrxRadioGroupItem,
} from "@/components/ui/samples/radio-group";
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        Demo of MatrxRadioGroup and MatrxCheckbox Components
      </h1>
      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="basic">
          ...
          <Card className="mt-4">
            ...
            <CardContent>
              <pre>
                {JSON.stringify({ radioValue, checkboxValue }, null, 2)}
              </pre>
            </CardContent>
          </Card>
        </TabsContent>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedRadioChange("orientation", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedRadioChange("gap", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedRadioChange("animationLevel", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        value={
                          advancedCheckboxProps.lineThrough ? "true" : "false"
                        }
                        onValueChange={(value) =>
