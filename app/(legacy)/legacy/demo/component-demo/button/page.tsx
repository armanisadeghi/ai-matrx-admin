...
import {
  ...
  MatrxSelectTrigger,
  MatrxSelectValue,
} from "@/components/ui/samples/select";
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">
        Demo of the MatrxButton Component
      </h1>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("variant", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("size", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("animation", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleAdvancedChange("fullWidth", checked)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleAdvancedChange("loading", checked)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleAdvancedChange("ripple", checked)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAdvancedChange("tooltip", e.target.value)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleAdvancedChange("dropdown", checked)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAdvancedChange("count", Number(e.target.value))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleAdvancedChange("icon", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                  ...
                  <MatrxButton
                    ...
                    onClick={() =>
                      handleAdvancedChange(
                        "count",
                        advancedButtonState.count + 1,
                      )
                    }
                  >
                    {advancedButtonState.size === "icon"
                      ? ""
                      : "Advanced Button"}
                  </MatrxButton>
                </CardContent>
        ...
        <TabsContent value="groups">
          <Card>
            ...
            <CardContent>
              ...
              <ButtonGroup>
                <MatrxButton variant="outline" icon={<ThumbsUp />}>
                  Like
                </MatrxButton>
                <MatrxButton variant="outline" icon={<ThumbsDown />}>
                  Dislike
                </MatrxButton>
                <MatrxButton variant="outline" icon={<Star />}>
                  Favorite
                </MatrxButton>
              </ButtonGroup>
        ...
        <TabsContent value="all">
          <Card>
            ...
            <CardContent>
              ...
              <MatrxButton variant="destructive">
                Destructive Button
              </MatrxButton>
              ...
              <MatrxButton icon={<Loader2 className="h-4 w-4" />}>
                Button with Icon
              </MatrxButton>
              ...
              <div className="flex space-x-2">
                ...
                <MatrxButton animation="moderate">
                  Moderate Animation
                </MatrxButton>
                <MatrxButton animation="enhanced">
                  Enhanced Animation
                </MatrxButton>
              </div>
