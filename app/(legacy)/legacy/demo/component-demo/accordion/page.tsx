          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-background rounded-lg shadow-sm">
              ...
              <p className="text-sm text-muted-foreground">
                Customizable motion and transitions
              </p>
            </div>
            <div className="p-4 bg-background rounded-lg shadow-sm">
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value) =>
            setAccordionConfig((prev) => ({
              ...prev,
              theme: value as "default" | "elevated" | "subtle",
            }))
          }
        >
          <SelectTrigger>
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value) =>
            setAccordionConfig((prev) => ({
              ...prev,
              borderStyle: value as "none" | "subtle" | "solid",
            }))
          }
        >
          <SelectTrigger>
      ...
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setAccordionConfig((prev) => ({
              ...prev,
              iconPosition: value as "left" | "right",
            }))
          }
    ...
    <div className="container mx-auto p-4 space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground">
          An advanced, customizable accordion component with rich features and
          animations
        </p>
      </motion.div>
              ...
              <CardContent>
                ...
                >
                  {richAccordionItems.map((item) => (
                    <MatrxAccordionItem key={item.value} value={item.value}>
                      <MatrxAccordionTrigger
                        iconPosition={accordionConfig.iconPosition}
                      >
                        {item.trigger}
                      </MatrxAccordionTrigger>
                      <MatrxAccordionContent>
                  ...
                  <MatrxAccordionItem value="lazy">
                    ...
                    <MatrxAccordionContent lazyLoad>
                      <div className="space-y-4">
                        ...
                        <p>
                          This content is loaded only when the accordion is
                          opened.
                        </p>
                      </div>
                    </MatrxAccordionContent>
