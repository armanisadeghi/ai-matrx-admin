...
export const ENTITY_SELECT_STYLES = [
  "default",
  "minimal",
  "compact",
  "card",
...
export const ENTITY_SELECT_VARIANTS = [
  "default",
  "grid",
  "chips",
  "command",
...
export const INLINE_ENTITY_COMPONENT_STYLES = [
  "accordion",
  "tabs",
  "list",
] as const;
export type InlineEntityComponentStyles =
  (typeof INLINE_ENTITY_COMPONENT_STYLES)[number];
...
export type QuickReferenceComponentType =
  (typeof QUICK_REFERENCE_COMPONENT_TYPES)[number];
...
// String-only options
export const animationPresetOptions =
  createStringSelectOptions(ANIMATION_PRESETS);
...
export const inlineEntityStyleOptions = createStringSelectOptions(
  INLINE_ENTITY_COMPONENT_STYLES,
);
export const componentStateOptions =
  createStringSelectOptions(COMPONENT_STATES);
export const quickReferenceComponentOptions = createStringSelectOptions(
  QUICK_REFERENCE_COMPONENT_TYPES,
);
export const formVariationOptions = createStringSelectOptions(FORM_VARIATIONS);
export const entityFormTypeOptions = createStringSelectOptions(
  ENTITY_FORM_COMPONENT_VARIATIONS,
);

// Mixed number|string options
export const formColumnOptions = createMixedSelectOptions(FORM_COLUMNS);
export const inlineEntityColumnOptions = createMixedSelectOptions(
  INLINE_ENTITY_COLUMNS,
);
export const entitySelectStyleOptions =
  createSelectOptions(ENTITY_SELECT_STYLES);
export const entitySelectVariantOptions = createSelectOptions(
  ENTITY_SELECT_VARIANTS,
);
...
export interface MatrxBaseInputProps
  extends
    BaseMatrxProps,
    Omit<React.InputHTMLAttributes<HTMLInputElement>, keyof BaseMatrxProps> {
  startAdornment?: React.ReactNode;
  endAdornment?: React.ReactNode;
}
