  ...
  public: {
    Tables: {
      ...
      app_instances: {
        ...
        Relationships: [
          {
            foreignKeyName: "app_instances_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      pc_episodes: {
        ...
        Relationships: [
          {
            foreignKeyName: "pc_episodes_show_id_fkey"
            columns: ["show_id"]
            isOneToOne: false
      ...
      prompt_builtins: {
        ...
        Relationships: [
          {
            foreignKeyName: "prompt_builtins_model_id_fkey"
            columns: ["model_id"]
            isOneToOne: false
            referencedRelation: "ai_model"
            referencedColumns: ["id"]
      ...
      rs_analysis: {
        ...
        Relationships: [
          {
            foreignKeyName: "rs_analysis_content_id_fkey"
            columns: ["content_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "rs_analysis_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
      ...
      rs_content: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rs_content_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "rs_topic"
            referencedColumns: ["id"]
      ...
      rs_media: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rs_media_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "rs_topic"
            referencedColumns: ["id"]
      ...
      rs_synthesis: {
        ...
        Relationships: [
          {
            foreignKeyName: "rs_synthesis_keyword_id_fkey"
            columns: ["keyword_id"]
            isOneToOne: false
            referencedRelation: "rs_keyword"
            referencedColumns: ["id"]
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "rs_synthesis"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "rs_synthesis_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
            referencedRelation: "rs_tag"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rs_synthesis_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "rs_topic"
            referencedColumns: ["id"]
      ...
      rs_topic: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "rs_template"
            referencedColumns: ["id"]
          },
        ]
      }
      sandbox_instances: {
        ...
        Relationships: [
          {
            foreignKeyName: "sandbox_instances_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      sms_media: {
        ...
        Relationships: [
          {
            foreignKeyName: "sms_media_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
      ...
      sms_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "sms_notifications_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "sms_messages"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_database_function_by_id: {
        Args: { function_id: string }
        Returns: {
          arguments: string
          definition: string
          name: string
