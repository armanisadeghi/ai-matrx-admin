...
import { FetchStrategy } from "@/types/automationSchemaPrimitives";
...
import type {
  ...
  ExtractType,
  TypeBrand,
} from "@/types/automationSchemaPrimitives";

export type { EnumValues, ExtractType, TypeBrand };
...
export type AllEntityFieldKeys =
  AutomationSchema[EntityKeys] extends infer TField
...
export type CanonicalFieldKey<TEntity extends EntityKeys> =
  EntityFieldKeys<TEntity> extends infer K
    ? K extends string
      ? K
      : never
    : never;
...
export type EntityDatabaseTable<TEntity extends EntityKeys> =
...
export type AnyDatabaseColumnForEntity<TEntity extends EntityKeys> =
  FieldDatabaseColumn<TEntity, EntityFieldKeys<TEntity>>;

export type AllDatabaseColumnsAllEntities = {
  [Entity in EntityKeys]: AnyDatabaseColumnForEntity<Entity>;
}[EntityKeys];

// Full relationship graph (moved from utils/schema/fullRelationships to break type cycles)
...
export type EntityDefaultFetchStrategy<TEntity extends EntityKeys> = Extract<
...
export type WhereClause<TEntity extends EntityKeys> = Record<
  ExtractPrimaryKeyInfo<TEntity>["database_fields"][number],
  unknown
>;
...
export type FieldNameDatabaseMap = Record<
  EntityNameOfficial,
  Record<string, string>
>;
export type FieldNameBackendMap = Record<
  EntityNameOfficial,
  Record<string, string>
>;
...
export type EntityNameFormatMap = {
  [TEntity in EntityKeys]: {
    [TFormat in keyof EntityNameFormats<TEntity>]: EntityNameFormat<
      TEntity,
      TFormat
    >;
  };
...
export type FieldNameFormatMap = {
  [TEntity in EntityKeys]: {
    [TField in EntityFieldKeys<TEntity>]: {
      [TFormat in keyof FieldNameFormats<TEntity, TField>]: FieldNameFormat<
        TEntity,
        TField,
        TFormat
      >;
...
export type EntityRecord<
  ...
  TFormat extends DataFormat,
> = {
  [K in EntityFieldKeys<TEntity> as EntityNameFormat<
    TEntity,
    TFormat
...
export function assertFormat<
  T extends Record<string, unknown>,
  F extends DataFormat,
>(value: T, format: F): asserts value is T & FormatBrand<T, F> {
...
export function enforceFieldTypes<
  TEntity extends EntityKeys,
  TFormat extends DataFormat,
>(entity: TEntity, data: Record<string, unknown>): Record<string, unknown> {
  const result: Record<string, unknown> = {};
...
export type EntityData<TEntity extends EntityKeys> = {
  [TField in keyof AutomationEntity<TEntity>["entityFields"] as AutomationEntity<TEntity>["entityFields"][TField]["isNative"] extends true
    ? TField
    : never]: ExtractType<
    AutomationEntity<TEntity>["entityFields"][TField]["typeReference"]
  >;
} & {
...
export type EntityDataWithKey<TEntity extends EntityKeys> =
  EntityData<TEntity> & {
    matrxRecordId: MatrxRecordId;
  };

export type ProcessedEntityData<TEntity extends EntityKeys> =
  EntityData<TEntity> & {
    matrxRecordId?: MatrxRecordId;
    [key: string]: any;
  };
...
export type PrettyEntityName<TEntity extends EntityKeys> = EntityNameFormat<
  TEntity,
  "pretty"
>;
export type BackendEntityName<TEntity extends EntityKeys> = EntityNameFormat<
  TEntity,
  "backend"
>;
export type DatabaseEntityName<TEntity extends EntityKeys> = EntityNameFormat<
  TEntity,
  "database"
>;
...
export type BackendFieldName<
  TEntity extends EntityKeys,
  TField extends EntityFieldKeys<TEntity>,
> = FieldNameFormat<TEntity, TField, "backend">;
export type DatabaseFieldName<
  TEntity extends EntityKeys,
  TField extends EntityFieldKeys<TEntity>,
> = FieldNameFormat<TEntity, TField, "database">;
...
type regFuncModulePathFieldPretty = FieldNameFormat<
  "registeredFunction",
  "modulePath",
  "pretty"
>; // Shows "Module Path"
...
type registeredFunctionPrimaryKey = FieldIsPrimaryKey<
  "registeredFunction",
  "id"
>;
