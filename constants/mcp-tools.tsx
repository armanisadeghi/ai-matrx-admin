...
export const allTools: Tool[] = [
    ...
    },
    {
        id: "web_search",
        name: "Search",
        description: "This is the `web_search` tool. Search the internet and return long snippets from each result—useful for quick fact-checking.",
        category: "Web",
    ...
    },
    {
        id: "web_read",
        name: "Read",
        description: "This is the `web_read` tool. Fetch content from any website URL.",
        category: "Web",
    ...
    },
    {
        id: "web_search_v1",
        name: "Search V1",
        description: "This is the `web_search` tool. This tool allows you to search the web. You can use search operators like site:reddit.com when needed.",
        category: "Web",
        icon: <LucideIcons.Search size={20} />,
    },
    {
        id: "web_read_v1",
        name: "Read V1",
        description: "This is the `web_read` tool. This tool allows you to browse page by a URL and get summarized content.",
        category: "Web",
        icon: <LucideIcons.BookOpen size={20} />,
    },
    {
